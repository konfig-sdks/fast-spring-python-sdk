...
from fast_spring_python_sdk.paths.accounts_account_id_authenticate import get
from fast_spring_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestAccountsAccountIdAuthenticate(ApiTestMixin, unittest.TestCase):
    """
    AccountsAccountIdAuthenticate unit test stubs
