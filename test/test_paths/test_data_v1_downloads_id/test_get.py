...
from fast_spring_python_sdk.paths.data_v1_downloads_id import get
from fast_spring_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestDataV1DownloadsId(ApiTestMixin, unittest.TestCase):
    """
    DataV1DownloadsId unit test stubs
