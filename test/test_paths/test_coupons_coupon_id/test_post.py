...
from fast_spring_python_sdk.paths.coupons_coupon_id import post
from fast_spring_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCouponsCouponId(ApiTestMixin, unittest.TestCase):
    """
    CouponsCouponId unit test stubs
