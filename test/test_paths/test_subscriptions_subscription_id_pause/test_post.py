...
from fast_spring_python_sdk.paths.subscriptions_subscription_id_pause import post
from fast_spring_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestSubscriptionsSubscriptionIdPause(ApiTestMixin, unittest.TestCase):
    """
    SubscriptionsSubscriptionIdPause unit test stubs
