...
from fast_spring_python_sdk.paths.subscriptions_estimate import post
from fast_spring_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestSubscriptionsEstimate(ApiTestMixin, unittest.TestCase):
    """
    SubscriptionsEstimate unit test stubs
