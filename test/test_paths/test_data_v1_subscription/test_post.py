...
from fast_spring_python_sdk.paths.data_v1_subscription import post
from fast_spring_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestDataV1Subscription(ApiTestMixin, unittest.TestCase):
    """
    DataV1Subscription unit test stubs
