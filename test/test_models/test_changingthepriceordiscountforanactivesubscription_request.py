...
class TestChangingthepriceordiscountforanactivesubscriptionRequest(unittest.TestCase):
    """ChangingthepriceordiscountforanactivesubscriptionRequest unit test stubs"""
    pass
