...
from fast_spring_python_sdk import configuration


class TestAddingoreditingasubscriptionaddontoanactivesubscriptionRequest(unittest.TestCase):
    """AddingoreditingasubscriptionaddontoanactivesubscriptionRequest unit test stubs"""
    pass
