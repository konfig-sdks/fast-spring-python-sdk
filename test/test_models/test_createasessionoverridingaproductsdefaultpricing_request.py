...
class TestCreateasessionoverridingaproductsdefaultpricingRequest(unittest.TestCase):
    """CreateasessionoverridingaproductsdefaultpricingRequest unit test stubs"""
    pass
