...
class TestChangeasubscriptionfromautomaticrenewaltomanualRequest(unittest.TestCase):
    """ChangeasubscriptionfromautomaticrenewaltomanualRequest unit test stubs"""
    pass
