...
class GenerateSubscriptionReportRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def filter() -> typing.Type['FilterSubscriptionReportRequest']:
                return FilterSubscriptionReportRequest
        
            @staticmethod
            def reportColumns() -> typing.Type['GenerateSubscriptionReportRequestReportColumns']:
                return GenerateSubscriptionReportRequestReportColumns
        
            @staticmethod
            def groupBy() -> typing.Type['GenerateSubscriptionReportRequestGroupBy']:
                return GenerateSubscriptionReportRequestGroupBy
            ...
            @staticmethod
            def notificationEmails() -> typing.Type['GenerateSubscriptionReportRequestNotificationEmails']:
                return GenerateSubscriptionReportRequestNotificationEmails
            __annotations__ = {
                "filter": filter,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["filter"]) -> 'FilterSubscriptionReportRequest': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reportColumns"]) -> 'GenerateSubscriptionReportRequestReportColumns': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["groupBy"]) -> 'GenerateSubscriptionReportRequestGroupBy': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["notificationEmails"]) -> 'GenerateSubscriptionReportRequestNotificationEmails': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["filter"]) -> typing.Union['FilterSubscriptionReportRequest', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reportColumns"]) -> typing.Union['GenerateSubscriptionReportRequestReportColumns', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["groupBy"]) -> typing.Union['GenerateSubscriptionReportRequestGroupBy', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["notificationEmails"]) -> typing.Union['GenerateSubscriptionReportRequestNotificationEmails', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        filter: typing.Union['FilterSubscriptionReportRequest', schemas.Unset] = schemas.unset,
        reportColumns: typing.Union['GenerateSubscriptionReportRequestReportColumns', schemas.Unset] = schemas.unset,
        groupBy: typing.Union['GenerateSubscriptionReportRequestGroupBy', schemas.Unset] = schemas.unset,
        ...
        notificationEmails: typing.Union['GenerateSubscriptionReportRequestNotificationEmails', schemas.Unset] = schemas.unset,
