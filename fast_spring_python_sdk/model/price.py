...
class Price(
    ...
    class MetaOapg:
        ...
        class properties:
            USD = schemas.Float64Schema
            EUR = schemas.Float64Schema
            __annotations__ = {
                "USD": USD,
                "EUR": EUR,
            }
    
    EUR: MetaOapg.properties.EUR
    USD: MetaOapg.properties.USD
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["USD", "EUR", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["USD"]) -> MetaOapg.properties.USD: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EUR"]) -> MetaOapg.properties.EUR: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["USD", "EUR", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        EUR: typing.Union[MetaOapg.properties.EUR, decimal.Decimal, int, float, ],
        USD: typing.Union[MetaOapg.properties.USD, decimal.Decimal, int, float, ],
