...
class ItemRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["product", "unitListPrice", "quantity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["product", "unitListPrice", "quantity", ], str]):
