...
class AddingoreditingasubscriptionaddontoanactivesubscriptionRequest(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class subscriptions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Subscription3']:
                        return Subscription3
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Subscription3'], typing.List['Subscription3']],
                ...
                def __getitem__(self, i: int) -> 'Subscription3':
