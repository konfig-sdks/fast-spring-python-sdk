...
class Instructions(
    ...
    en: MetaOapg.properties.en
    es: MetaOapg.properties.es
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["en", "es", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["en"]) -> MetaOapg.properties.en: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["es"]) -> MetaOapg.properties.es: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["en", "es", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        en: typing.Union[MetaOapg.properties.en, str, ],
        es: typing.Union[MetaOapg.properties.es, str, ],
