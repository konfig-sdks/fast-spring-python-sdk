...
class AddcouponcodestoacouponRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def codes() -> typing.Type['AddcouponcodestoacouponRequestCodes']:
                return AddcouponcodestoacouponRequestCodes
            __annotations__ = {
                "codes": codes,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["codes"]) -> 'AddcouponcodestoacouponRequestCodes': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["codes"]) -> 'AddcouponcodestoacouponRequestCodes': ...
