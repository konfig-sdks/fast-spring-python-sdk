...
class ChangethedateQuantityorcouponforanactivesubscriptionRequest(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class subscriptions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Subscription1']:
                        return Subscription1
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Subscription1'], typing.List['Subscription1']],
                ...
                def __getitem__(self, i: int) -> 'Subscription1':
