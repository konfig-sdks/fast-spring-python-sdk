...
class ContactRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "first", "last", "company", "phone", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "first", "last", "company", "phone", ], str]):
