...
class Reason(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["en", "de", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["de"]) -> MetaOapg.properties.de: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["en", "de", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        de: typing.Union[MetaOapg.properties.de, str, ],
