...
class UpdateasingleeventRequest(
    schemas.DictSchema
):
    """
    ...
    processed: MetaOapg.properties.processed
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["processed", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["processed"]) -> MetaOapg.properties.processed: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["processed", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        processed: typing.Union[MetaOapg.properties.processed, bool, ],
