...
class Addon(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def pricing() -> typing.Type['Pricing5']:
                return Pricing5
            __annotations__ = {
                "product": product,
                "quantity": quantity,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pricing"]) -> 'Pricing5': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["product", "quantity", "pricing", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pricing"]) -> 'Pricing5': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["product", "quantity", "pricing", ], str]):
