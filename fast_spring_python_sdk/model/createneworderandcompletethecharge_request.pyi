...
class CreateneworderandcompletethechargeRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tags", "account", "coupon", "currency", "items", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tags", "account", "coupon", "currency", "items", ], str]):
