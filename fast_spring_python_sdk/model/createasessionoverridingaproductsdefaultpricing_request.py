...
class CreateasessionoverridingaproductsdefaultpricingRequest(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Item3']:
                        return Item3
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Item3'], typing.List['Item3']],
                ...
                def __getitem__(self, i: int) -> 'Item3':
