...
class Item3(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def pricing() -> typing.Type['Pricing3']:
                return Pricing3
            __annotations__ = {
                "product": product,
                "quantity": quantity,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pricing"]) -> 'Pricing3': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pricing"]) -> 'Pricing3': ...
