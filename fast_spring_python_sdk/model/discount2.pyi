...
class Discount2(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def amount() -> typing.Type['Amount2']:
                return Amount2
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["amount"]) -> 'Amount2': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "amount", "duration", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["amount"]) -> 'Amount2': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "amount", "duration", ], str]):
