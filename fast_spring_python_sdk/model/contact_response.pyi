...
class ContactResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["company", "email", "first", "last", "phone", "userId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["company", "email", "first", "last", "phone", "userId", ], str]):
