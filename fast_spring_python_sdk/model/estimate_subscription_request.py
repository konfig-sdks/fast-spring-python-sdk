...
class EstimateSubscriptionRequest(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class addons(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SubscriptionAddon']:
                        return SubscriptionAddon
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SubscriptionAddon'], typing.List['SubscriptionAddon']],
                ...
                def __getitem__(self, i: int) -> 'SubscriptionAddon':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["addons"]) -> MetaOapg.properties.addons: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["subscription", "product", "quantity", "pricing", "addons", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["addons"]) -> typing.Union[MetaOapg.properties.addons, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["subscription", "product", "quantity", "pricing", "addons", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        subscription: typing.Union[MetaOapg.properties.subscription, str, ],
        ...
        addons: typing.Union[MetaOapg.properties.addons, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
