...
class StatusHistoryResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class statusUpdatedTo(
                ...
                def EXPIRED(cls):
                    return cls("EXPIRED")
            statusUpdatedByFullName = schemas.StrSchema
            statusUpdatedByEmail = schemas.StrSchema
            statusUpdatedOn = schemas.DateTimeSchema
            __annotations__ = {
                "statusUpdatedTo": statusUpdatedTo,
                "statusUpdatedByFullName": statusUpdatedByFullName,
                "statusUpdatedByEmail": statusUpdatedByEmail,
                "statusUpdatedOn": statusUpdatedOn,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["statusUpdatedTo"]) -> MetaOapg.properties.statusUpdatedTo: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["statusUpdatedByFullName"]) -> MetaOapg.properties.statusUpdatedByFullName: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["statusUpdatedByEmail"]) -> MetaOapg.properties.statusUpdatedByEmail: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["statusUpdatedOn"]) -> MetaOapg.properties.statusUpdatedOn: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["statusUpdatedTo", "statusUpdatedByFullName", "statusUpdatedByEmail", "statusUpdatedOn", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["statusUpdatedTo"]) -> typing.Union[MetaOapg.properties.statusUpdatedTo, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["statusUpdatedByFullName"]) -> typing.Union[MetaOapg.properties.statusUpdatedByFullName, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["statusUpdatedByEmail"]) -> typing.Union[MetaOapg.properties.statusUpdatedByEmail, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["statusUpdatedOn"]) -> typing.Union[MetaOapg.properties.statusUpdatedOn, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["statusUpdatedTo", "statusUpdatedByFullName", "statusUpdatedByEmail", "statusUpdatedOn", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        statusUpdatedTo: typing.Union[MetaOapg.properties.statusUpdatedTo, str, schemas.Unset] = schemas.unset,
        statusUpdatedByFullName: typing.Union[MetaOapg.properties.statusUpdatedByFullName, str, schemas.Unset] = schemas.unset,
        statusUpdatedByEmail: typing.Union[MetaOapg.properties.statusUpdatedByEmail, str, schemas.Unset] = schemas.unset,
        statusUpdatedOn: typing.Union[MetaOapg.properties.statusUpdatedOn, str, datetime, schemas.Unset] = schemas.unset,
