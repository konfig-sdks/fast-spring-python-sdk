...
class ItemTaxResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            taxValue = schemas.NumberSchema
            totalTaxable = schemas.NumberSchema
            __annotations__ = {
                "taxValue": taxValue,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["taxValue"]) -> MetaOapg.properties.taxValue: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalTaxable"]) -> MetaOapg.properties.totalTaxable: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["taxValue", "totalTaxable", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["taxValue"]) -> typing.Union[MetaOapg.properties.taxValue, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalTaxable"]) -> typing.Union[MetaOapg.properties.totalTaxable, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["taxValue", "totalTaxable", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        taxValue: typing.Union[MetaOapg.properties.taxValue, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        totalTaxable: typing.Union[MetaOapg.properties.totalTaxable, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
