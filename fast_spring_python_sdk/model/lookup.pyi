...
class Lookup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["custom", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["custom", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        custom: typing.Union[MetaOapg.properties.custom, str, ],
