...
class Pageable(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["offset", "paged", "unpaged", "sort", "pageNumber", "pageSize", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["offset", "paged", "unpaged", "sort", "pageNumber", "pageSize", ], str]):
