...
class FilterSubscriptionReportRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def countryISO() -> typing.Type['FilterSubscriptionReportRequestCountryIso']:
                return FilterSubscriptionReportRequestCountryIso
        
            @staticmethod
            def productNames() -> typing.Type['FilterSubscriptionReportRequestProductNames']:
                return FilterSubscriptionReportRequestProductNames
        
            @staticmethod
            def productPaths() -> typing.Type['FilterSubscriptionReportRequestProductPaths']:
                return FilterSubscriptionReportRequestProductPaths
            syncDate = schemas.DateSchema
            __annotations__ = {
                "startDate": startDate,
                "endDate": endDate,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["countryISO"]) -> 'FilterSubscriptionReportRequestCountryIso': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["productNames"]) -> 'FilterSubscriptionReportRequestProductNames': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["productPaths"]) -> 'FilterSubscriptionReportRequestProductPaths': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["startDate", "endDate", "countryISO", "productNames", "productPaths", "syncDate", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["countryISO"]) -> typing.Union['FilterSubscriptionReportRequestCountryIso', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["productNames"]) -> typing.Union['FilterSubscriptionReportRequestProductNames', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["productPaths"]) -> typing.Union['FilterSubscriptionReportRequestProductPaths', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startDate", "endDate", "countryISO", "productNames", "productPaths", "syncDate", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        countryISO: typing.Union['FilterSubscriptionReportRequestCountryIso', schemas.Unset] = schemas.unset,
        productNames: typing.Union['FilterSubscriptionReportRequestProductNames', schemas.Unset] = schemas.unset,
        productPaths: typing.Union['FilterSubscriptionReportRequestProductPaths', schemas.Unset] = schemas.unset,
        syncDate: typing.Union[MetaOapg.properties.syncDate, str, date, schemas.Unset] = schemas.unset,
