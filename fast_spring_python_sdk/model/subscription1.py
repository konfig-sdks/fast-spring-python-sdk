...
class Subscription1(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def coupons() -> typing.Type['Subscription1Coupons']:
                return Subscription1Coupons
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["coupons"]) -> 'Subscription1Coupons': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["subscription", "next", "end", "quantity", "coupons", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["coupons"]) -> 'Subscription1Coupons': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["subscription", "next", "end", "quantity", "coupons", ], str]):
