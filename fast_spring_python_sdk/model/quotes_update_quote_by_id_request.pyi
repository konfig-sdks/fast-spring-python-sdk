...
class QuotesUpdateQuoteByIdRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def updateQuoteRequest() -> typing.Type['UpdateQuoteRequest']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["updateQuoteRequest"]) -> 'UpdateQuoteRequest': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["updateQuoteRequest", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["updateQuoteRequest"]) -> typing.Union['UpdateQuoteRequest', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["updateQuoteRequest", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        updateQuoteRequest: typing.Union['UpdateQuoteRequest', schemas.Unset] = schemas.unset,
