...
class CreateQuoteRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["items", "name", "recipientAddress", "recipient", "tags", "coupon", "currency", "expirationDateDays", "fulfillmentTerm", "notes", "netTermsDays", "taxId", "source", "sourceIP", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["items", "name", "recipientAddress", "recipient", "tags", "coupon", "currency", "expirationDateDays", "fulfillmentTerm", "notes", "netTermsDays", "taxId", "source", "sourceIP", ], str]):
