...
class CreateasessionapplyingacoupontoanorderRequest(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Item2']:
                        return Item2
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Item2'], typing.List['Item2']],
                ...
                def __getitem__(self, i: int) -> 'Item2':
    ...
    coupon: MetaOapg.properties.coupon
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account", "items", "coupon", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["coupon"]) -> MetaOapg.properties.coupon: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account", "items", "coupon", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        coupon: typing.Union[MetaOapg.properties.coupon, str, ],
