...
class Tags1(
    ...
    class MetaOapg:
        ...
        class properties:
            TagKey1 = schemas.StrSchema
            TagKey2 = schemas.StrSchema
            __annotations__ = {
                "TagKey1": TagKey1,
                "TagKey2": TagKey2,
            }
    
    TagKey1: MetaOapg.properties.TagKey1
    TagKey2: MetaOapg.properties.TagKey2
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TagKey1"]) -> MetaOapg.properties.TagKey1: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TagKey2"]) -> MetaOapg.properties.TagKey2: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TagKey1", "TagKey2", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TagKey1"]) -> MetaOapg.properties.TagKey1: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TagKey2"]) -> MetaOapg.properties.TagKey2: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TagKey1", "TagKey2", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        TagKey1: typing.Union[MetaOapg.properties.TagKey1, str, ],
        TagKey2: typing.Union[MetaOapg.properties.TagKey2, str, ],
