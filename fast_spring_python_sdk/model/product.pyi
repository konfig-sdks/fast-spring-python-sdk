...
class Product(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def display() -> typing.Type['Display']:
                return Display
        
            @staticmethod
            def fulfillment() -> typing.Type['Fulfillment']:
                return Fulfillment
            ...
            @staticmethod
            def attributes() -> typing.Type['Attributes2']:
                return Attributes2
        
            @staticmethod
            def pricing() -> typing.Type['Pricing1']:
                return Pricing1
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["display"]) -> 'Display': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fulfillment"]) -> 'Fulfillment': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attributes"]) -> 'Attributes2': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pricing"]) -> 'Pricing1': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "product", "display", "fulfillment", "image", "format", "sku", "attributes", "pricing", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["description"]) -> 'Description': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["product"]) -> MetaOapg.properties.product: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["display"]) -> 'Display': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fulfillment"]) -> 'Fulfillment': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attributes"]) -> 'Attributes2': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pricing"]) -> 'Pricing1': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "product", "display", "fulfillment", "image", "format", "sku", "attributes", "pricing", ], str]):
