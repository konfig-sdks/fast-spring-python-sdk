...
class Attributes1(
    ...
    class MetaOapg:
        ...
        class properties:
            AttributeKey1 = schemas.StrSchema
            AttributeKey2 = schemas.StrSchema
            __annotations__ = {
                "AttributeKey1": AttributeKey1,
                "AttributeKey2": AttributeKey2,
            }
    
    AttributeKey2: MetaOapg.properties.AttributeKey2
    AttributeKey1: MetaOapg.properties.AttributeKey1
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AttributeKey1"]) -> MetaOapg.properties.AttributeKey1: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AttributeKey2"]) -> MetaOapg.properties.AttributeKey2: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AttributeKey1", "AttributeKey2", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AttributeKey1"]) -> MetaOapg.properties.AttributeKey1: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AttributeKey2"]) -> MetaOapg.properties.AttributeKey2: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AttributeKey1", "AttributeKey2", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        AttributeKey2: typing.Union[MetaOapg.properties.AttributeKey2, str, ],
        AttributeKey1: typing.Union[MetaOapg.properties.AttributeKey1, str, ],
