...
class Discount3(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "percentage", "duration", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "percentage", "duration", ], str]):
