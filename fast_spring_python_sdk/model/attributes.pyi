...
class Attributes(
    ...
    class MetaOapg:
        ...
        class properties:
            ATTRIBUTE1 = schemas.StrSchema
            __annotations__ = {
                "ATTRIBUTE1": ATTRIBUTE1,
            }
    
    ATTRIBUTE1: MetaOapg.properties.ATTRIBUTE1
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ATTRIBUTE1"]) -> MetaOapg.properties.ATTRIBUTE1: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ATTRIBUTE1", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ATTRIBUTE1"]) -> MetaOapg.properties.ATTRIBUTE1: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ATTRIBUTE1", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ATTRIBUTE1: typing.Union[MetaOapg.properties.ATTRIBUTE1, str, ],
