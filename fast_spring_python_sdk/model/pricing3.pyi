...
class Pricing3(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price"]) -> 'Price3': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price"]) -> 'Price3': ...
