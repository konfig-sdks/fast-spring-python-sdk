...
class Pricing5(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price() -> typing.Type['Price4']:
                return Price4
        
            @staticmethod
            def discount() -> typing.Type['Discount3']:
                return Discount3
            __annotations__ = {
                "price": price,
                "discount": discount,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price"]) -> 'Price4': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["discount"]) -> 'Discount3': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["price", "discount", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price"]) -> 'Price4': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["discount"]) -> 'Discount3': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["price", "discount", ], str]):
