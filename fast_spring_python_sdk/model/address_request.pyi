...
class AddressRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["addressLine1", "addressLine2", "city", "country", "postalCode", "region", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["addressLine1", "addressLine2", "city", "country", "postalCode", "region", ], str]):
