...
class WebhooksUpdateWebhookKeySecret400Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['WebhooksUpdateWebhookKeySecret400ResponseError']:
                return WebhooksUpdateWebhookKeySecret400ResponseError
            __annotations__ = {
                "action": action,
                "result": result,
                "error": error,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'WebhooksUpdateWebhookKeySecret400ResponseError': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["action", "result", "error", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['WebhooksUpdateWebhookKeySecret400ResponseError', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["action", "result", "error", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['WebhooksUpdateWebhookKeySecret400ResponseError', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'WebhooksUpdateWebhookKeySecret400Response':
