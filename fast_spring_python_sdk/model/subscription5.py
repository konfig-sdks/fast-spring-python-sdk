...
class Subscription5(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            manualRenew = schemas.StrSchema
            __annotations__ = {
                "subscription": subscription,
                "manualRenew": manualRenew,
            }
    
    manualRenew: MetaOapg.properties.manualRenew
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["manualRenew"]) -> MetaOapg.properties.manualRenew: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["subscription", "manualRenew", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["manualRenew"]) -> MetaOapg.properties.manualRenew: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["subscription", "manualRenew", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        manualRenew: typing.Union[MetaOapg.properties.manualRenew, str, ],
