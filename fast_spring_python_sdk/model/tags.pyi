...
class Tags(
    ...
    class MetaOapg:
        ...
        class properties:
            tag1 = schemas.StrSchema
            __annotations__ = {
                "tag1": tag1,
            }
    
    tag1: MetaOapg.properties.tag1
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tag1"]) -> MetaOapg.properties.tag1: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tag1", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tag1"]) -> MetaOapg.properties.tag1: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tag1", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        tag1: typing.Union[MetaOapg.properties.tag1, str, ],
