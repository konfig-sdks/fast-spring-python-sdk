...
class Order(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tags"]) -> 'Tags1': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tags", "order", "items", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tags"]) -> 'Tags1': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tags", "order", "items", ], str]):
