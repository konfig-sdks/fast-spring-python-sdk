...
class CollectionModelQuoteResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['QuoteResponse']:
                        return QuoteResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['QuoteResponse'], typing.List['QuoteResponse']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'content':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'QuoteResponse':
                    return super().__getitem__(i)
            __annotations__ = {
                "links": links,
                "content": content,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["links", "content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["links", "content", ], str]):
