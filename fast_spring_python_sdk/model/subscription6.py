...
class Subscription6(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            deactivation = schemas.StrSchema
            __annotations__ = {
    ...
    deactivation: MetaOapg.properties.deactivation
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subscription"]) -> MetaOapg.properties.subscription: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deactivation"]) -> MetaOapg.properties.deactivation: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["subscription", "deactivation", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deactivation"]) -> MetaOapg.properties.deactivation: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["subscription", "deactivation", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        deactivation: typing.Union[MetaOapg.properties.deactivation, str, ],
