...
class RebillmanagedsubscriptioninstanceRequest(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class subscriptions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Subscription7']:
                        return Subscription7
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Subscription7'], typing.List['Subscription7']],
                ...
                def __getitem__(self, i: int) -> 'Subscription7':
