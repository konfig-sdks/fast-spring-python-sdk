...
class StoreEntitlement(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def roles() -> typing.Type['StoreEntitlementRoles']:
                return StoreEntitlementRoles
            __annotations__ = {
                "siteId": siteId,
                "roles": roles,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles"]) -> 'StoreEntitlementRoles': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["siteId", "roles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles"]) -> typing.Union['StoreEntitlementRoles', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["siteId", "roles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        roles: typing.Union['StoreEntitlementRoles', schemas.Unset] = schemas.unset,
