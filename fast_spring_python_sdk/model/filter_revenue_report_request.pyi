...
class FilterRevenueReportRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def countryISO() -> typing.Type['FilterRevenueReportRequestCountryIso']:
                return FilterRevenueReportRequestCountryIso
        
            @staticmethod
            def productNames() -> typing.Type['FilterRevenueReportRequestProductNames']:
                return FilterRevenueReportRequestProductNames
        
            @staticmethod
            def productPaths() -> typing.Type['FilterRevenueReportRequestProductPaths']:
                return FilterRevenueReportRequestProductPaths
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["countryISO"]) -> 'FilterRevenueReportRequestCountryIso': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["productNames"]) -> 'FilterRevenueReportRequestProductNames': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["productPaths"]) -> 'FilterRevenueReportRequestProductPaths': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["countryISO"]) -> typing.Union['FilterRevenueReportRequestCountryIso', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["productNames"]) -> typing.Union['FilterRevenueReportRequestProductNames', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["productPaths"]) -> typing.Union['FilterRevenueReportRequestProductPaths', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        countryISO: typing.Union['FilterRevenueReportRequestCountryIso', schemas.Unset] = schemas.unset,
        productNames: typing.Union['FilterRevenueReportRequestProductNames', schemas.Unset] = schemas.unset,
        productPaths: typing.Union['FilterRevenueReportRequestProductPaths', schemas.Unset] = schemas.unset,
