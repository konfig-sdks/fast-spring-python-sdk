...
class PauseSubscriptionRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            pausePeriodCount = schemas.Int32Schema
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pausePeriodCount"]) -> MetaOapg.properties.pausePeriodCount: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pausePeriodCount", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pausePeriodCount"]) -> typing.Union[MetaOapg.properties.pausePeriodCount, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pausePeriodCount", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        pausePeriodCount: typing.Union[MetaOapg.properties.pausePeriodCount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
