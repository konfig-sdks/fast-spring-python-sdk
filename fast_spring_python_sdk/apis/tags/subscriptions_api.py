...
from fast_spring_python_sdk.paths.subscriptions_subscription_id.delete import CancelSubscriptionById
from fast_spring_python_sdk.paths.subscriptions_subscription_id_convert.post import ConvertExpiredTrialWithoutPaymentMethod
from fast_spring_python_sdk.paths.subscriptions.get import GetAllSubscriptions
from fast_spring_python_sdk.paths.subscriptions_subscription_id.get import GetById
from fast_spring_python_sdk.paths.subscriptions_subscription_id_entries.get import GetEntries
from fast_spring_python_sdk.paths.subscriptions_subscription_id_history.get import GetPlanChangeHistory
from fast_spring_python_sdk.paths.subscriptions_subscription_id_pause.post import PauseSubscription
from fast_spring_python_sdk.paths.subscriptions_estimate.post import PreviewPlanChange
from fast_spring_python_sdk.paths.subscriptions_charge.post import RebillManagedSubscription
from fast_spring_python_sdk.paths.subscriptions_subscription_id_resume.post import RemoveScheduledPause
from fast_spring_python_sdk.paths.subscriptions_subscription_id.post import ResumeSubscription
from fast_spring_python_sdk.paths.subscriptions.post import UpdateSubscription
from fast_spring_python_sdk.apis.tags.subscriptions_api_raw import SubscriptionsApiRaw
...
class SubscriptionsApi(
    ...
    """
    raw: SubscriptionsApiRaw

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.raw = SubscriptionsApiRaw(api_client)
