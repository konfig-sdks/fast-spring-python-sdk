...
from fast_spring_python_sdk.paths.ordersbeginbegin_dateendend_datelimitlimitpagepage.get import GetByDateRangeRaw
from fast_spring_python_sdk.paths.ordersendend_date.get import GetByEndDateRaw
from fast_spring_python_sdk.paths.orders_order_id.get import GetByIdRaw
from fast_spring_python_sdk.paths.ordersproductsproduct_pathlimitlimitpagepage.get import GetByProductPathRaw
from fast_spring_python_sdk.paths.ordersproductsproduct_pathbeginbegin_dateendend_date.get import GetByProductPathAndDateRangeRaw
from fast_spring_python_sdk.paths.ordersbeginbegin_dateendend_datereturnsreturn.get import GetOrdersWithReturnsRaw
from fast_spring_python_sdk.paths.orders.post import UpdateTagsAndAttributesRaw
...
class OrdersApiRaw(
    ...
    GetByIdRaw,
    GetByProductPathRaw,
    GetByProductPathAndDateRangeRaw,
    GetOrdersWithReturnsRaw,
    UpdateTagsAndAttributesRaw,
):
    """NOTE:
