...
from fast_spring_python_sdk.paths.coupons_coupon_id.post import AssignCodesToCouponRaw
from fast_spring_python_sdk.paths.coupons.post import CreateNewCouponRaw
from fast_spring_python_sdk.paths.coupons_coupon_id_codes.delete import DeleteAssociatedCodesRaw
from fast_spring_python_sdk.paths.coupons_coupon_id_codes.get import GetCodesAssignedToCouponRaw
from fast_spring_python_sdk.paths.coupons_coupon_id.get import GetDetailsRaw


class CouponsApiRaw(
    AssignCodesToCouponRaw,
    CreateNewCouponRaw,
    DeleteAssociatedCodesRaw,
    GetCodesAssignedToCouponRaw,
    GetDetailsRaw,
):
    """NOTE:
