...
from fast_spring_python_sdk.paths.data_v1_downloads_id.get import DownloadReportByIdRaw
from fast_spring_python_sdk.paths.data_v1_revenue.post import GenerateRevenueReportRaw
from fast_spring_python_sdk.paths.data_v1_subscription.post import GenerateSubscriptionReportRaw
from fast_spring_python_sdk.paths.data_v1_jobs_id.get import GetJobInformationRaw
from fast_spring_python_sdk.paths.data_v1_jobs.get import GetJobInformation0Raw
from fast_spring_python_sdk.paths.data_v1_util_cache.get import ResetCacheForServiceEndPointsRaw


class DataApiRaw(
    DownloadReportByIdRaw,
    GenerateRevenueReportRaw,
    GenerateSubscriptionReportRaw,
    GetJobInformationRaw,
    GetJobInformation0Raw,
    ResetCacheForServiceEndPointsRaw,
):
    """NOTE:
