...
from fast_spring_python_sdk.paths.products.post import CreateAndUpdateRaw
from fast_spring_python_sdk.paths.products_offers_product_path.post import CreateOrUpdateOffersRaw
from fast_spring_python_sdk.paths.products_id.delete import DeleteProductByIdRaw
from fast_spring_python_sdk.paths.products_offers_product_path.get import GetAllOffersByTypeRaw
from fast_spring_python_sdk.paths.products.get import GetAllProductIdsRaw
from fast_spring_python_sdk.paths.products_price.get import GetAllProductPricesRaw
from fast_spring_python_sdk.paths.products_pricecountrycountry.get import GetAllProductPricesByCountryRaw
from fast_spring_python_sdk.paths.products_pricecountrycountrycurrencycurrency.get import GetAllProductPricesByCountryAndCurrencyRaw
from fast_spring_python_sdk.paths.products_product_path.get import GetByProductPathRaw
from fast_spring_python_sdk.paths.products_price_id.get import GetPriceByIdRaw
from fast_spring_python_sdk.paths.products_price_idcountrycountry.get import GetProductPriceByCountryRaw
from fast_spring_python_sdk.paths.products_price_idcountrycountrycurrencycurrency.get import GetProductPriceByCountryAndCurrencyRaw


class ProductsApiRaw(
    CreateAndUpdateRaw,
    CreateOrUpdateOffersRaw,
    DeleteProductByIdRaw,
    GetAllOffersByTypeRaw,
    GetAllProductIdsRaw,
    GetAllProductPricesRaw,
    GetAllProductPricesByCountryRaw,
    GetAllProductPricesByCountryAndCurrencyRaw,
    GetByProductPathRaw,
    GetPriceByIdRaw,
    GetProductPriceByCountryRaw,
    GetProductPriceByCountryAndCurrencyRaw,
):
    """NOTE:
