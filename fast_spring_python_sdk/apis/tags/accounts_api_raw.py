...
from fast_spring_python_sdk.paths.accounts.post import CreateNewAccountRaw
from fast_spring_python_sdk.paths.accounts_account_id.get import GetAccountByIdRaw
from fast_spring_python_sdk.paths.accounts_account_id_authenticate.get import GetAuthenticatedManagementUrlRaw
from fast_spring_python_sdk.paths.accounts.get import GetByParameterRaw
from fast_spring_python_sdk.paths.accounts_account_id.post import UpdateAccountByIdRaw


class AccountsApiRaw(
    CreateNewAccountRaw,
    GetAccountByIdRaw,
    GetAuthenticatedManagementUrlRaw,
    GetByParameterRaw,
    UpdateAccountByIdRaw,
):
    """NOTE:
