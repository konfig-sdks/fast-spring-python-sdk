...
from fast_spring_python_sdk.paths.subscriptions_subscription_id.delete import CancelSubscriptionByIdRaw
from fast_spring_python_sdk.paths.subscriptions_subscription_id_convert.post import ConvertExpiredTrialWithoutPaymentMethodRaw
from fast_spring_python_sdk.paths.subscriptions.get import GetAllSubscriptionsRaw
from fast_spring_python_sdk.paths.subscriptions_subscription_id.get import GetByIdRaw
from fast_spring_python_sdk.paths.subscriptions_subscription_id_entries.get import GetEntriesRaw
from fast_spring_python_sdk.paths.subscriptions_subscription_id_history.get import GetPlanChangeHistoryRaw
from fast_spring_python_sdk.paths.subscriptions_subscription_id_pause.post import PauseSubscriptionRaw
from fast_spring_python_sdk.paths.subscriptions_estimate.post import PreviewPlanChangeRaw
from fast_spring_python_sdk.paths.subscriptions_charge.post import RebillManagedSubscriptionRaw
from fast_spring_python_sdk.paths.subscriptions_subscription_id_resume.post import RemoveScheduledPauseRaw
from fast_spring_python_sdk.paths.subscriptions_subscription_id.post import ResumeSubscriptionRaw
from fast_spring_python_sdk.paths.subscriptions.post import UpdateSubscriptionRaw


class SubscriptionsApiRaw(
    CancelSubscriptionByIdRaw,
    ConvertExpiredTrialWithoutPaymentMethodRaw,
    GetAllSubscriptionsRaw,
    GetByIdRaw,
    GetEntriesRaw,
    GetPlanChangeHistoryRaw,
    PauseSubscriptionRaw,
    PreviewPlanChangeRaw,
    RebillManagedSubscriptionRaw,
    RemoveScheduledPauseRaw,
    ResumeSubscriptionRaw,
