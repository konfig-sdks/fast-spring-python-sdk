...
from fast_spring_python_sdk.paths.events_processed.get import GetProcessedEventsRaw
from fast_spring_python_sdk.paths.events_unprocessed.get import GetUnprocessedEventsRaw
from fast_spring_python_sdk.paths.events_event_id.post import UpdateEventByIdRaw


class EventsApiRaw(
    GetProcessedEventsRaw,
    GetUnprocessedEventsRaw,
    UpdateEventByIdRaw,
):
    """NOTE:
