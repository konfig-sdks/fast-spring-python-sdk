...
from fast_spring_python_sdk.type.subscription7 import Subscription7

class RequiredRebillmanagedsubscriptioninstanceRequest(TypedDict):
    subscriptions: typing.List[Subscription7]

class OptionalRebillmanagedsubscriptioninstanceRequest(TypedDict, total=False):
    pass

class RebillmanagedsubscriptioninstanceRequest(RequiredRebillmanagedsubscriptioninstanceRequest, OptionalRebillmanagedsubscriptioninstanceRequest):
    pass
