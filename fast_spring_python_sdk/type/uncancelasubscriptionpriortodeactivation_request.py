...
class RequiredUncancelasubscriptionpriortodeactivationRequest(TypedDict):
    subscriptions: typing.List[Subscription6]

class OptionalUncancelasubscriptionpriortodeactivationRequest(TypedDict, total=False):
    pass

class UncancelasubscriptionpriortodeactivationRequest(RequiredUncancelasubscriptionpriortodeactivationRequest, OptionalUncancelasubscriptionpriortodeactivationRequest):
    pass
