...
from fast_spring_python_sdk.type.pricing4 import Pricing4

class RequiredSubscription2(TypedDict):
    subscription: str

    pricing: Pricing4

class OptionalSubscription2(TypedDict, total=False):
    pass

class Subscription2(RequiredSubscription2, OptionalSubscription2):
    pass
