...
from fast_spring_python_sdk.type.discount_reason import DiscountReason
from fast_spring_python_sdk.type.price import Price
from fast_spring_python_sdk.type.pricing1_quantity_discounts import Pricing1QuantityDiscounts

class RequiredPricing1(TypedDict):
    trial: int
...
class OptionalPricing1(TypedDict, total=False):
...
class Pricing1(RequiredPricing1, OptionalPricing1):
    pass
