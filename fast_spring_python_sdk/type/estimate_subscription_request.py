...
class RequiredEstimateSubscriptionRequest(TypedDict):
    subscription: str

class OptionalEstimateSubscriptionRequest(TypedDict, total=False):
    product: str
    ...
    addons: typing.List[SubscriptionAddon]

class EstimateSubscriptionRequest(RequiredEstimateSubscriptionRequest, OptionalEstimateSubscriptionRequest):
    pass
