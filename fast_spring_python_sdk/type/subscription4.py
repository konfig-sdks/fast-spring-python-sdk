...
from fast_spring_python_sdk.type.addon1 import Addon1

class RequiredSubscription4(TypedDict):
    subscription: str

    addons: typing.List[Addon1]

class OptionalSubscription4(TypedDict, total=False):
    pass

class Subscription4(RequiredSubscription4, OptionalSubscription4):
    pass
