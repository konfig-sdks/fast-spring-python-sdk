...
class RequiredAddcouponcodestoacouponRequest(TypedDict):
    codes: AddcouponcodestoacouponRequestCodes

class OptionalAddcouponcodestoacouponRequest(TypedDict, total=False):
    pass

class AddcouponcodestoacouponRequest(RequiredAddcouponcodestoacouponRequest, OptionalAddcouponcodestoacouponRequest):
    pass
