...
RequiredGenerateRevenueReportRequest = TypedDict("RequiredGenerateRevenueReportRequest", {
    })

OptionalGenerateRevenueReportRequest = TypedDict("OptionalGenerateRevenueReportRequest", {
    "filter": FilterRevenueReportRequest,

    "reportColumns": GenerateRevenueReportRequestReportColumns,

    "groupBy": GenerateRevenueReportRequestGroupBy,
    ...
    "notificationEmails": GenerateRevenueReportRequestNotificationEmails,
    }, total=False)

class GenerateRevenueReportRequest(RequiredGenerateRevenueReportRequest, OptionalGenerateRevenueReportRequest):
    pass
