...
from fast_spring_python_sdk.type.pricing5 import Pricing5

class RequiredAddon(TypedDict):
    product: str
...
class OptionalAddon(TypedDict, total=False):
    pass

class Addon(RequiredAddon, OptionalAddon):
    pass
