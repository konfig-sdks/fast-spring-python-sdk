...
from fast_spring_python_sdk.type.entitlement_roles import EntitlementRoles
from fast_spring_python_sdk.type.entitlement_site_ids import EntitlementSiteIds
from fast_spring_python_sdk.type.store_entitlement import StoreEntitlement
...
class OptionalEntitlement(TypedDict, total=False):
    ...
    storeEntitlements: typing.List[StoreEntitlement]
