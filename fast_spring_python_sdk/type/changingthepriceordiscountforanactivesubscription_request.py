...
from fast_spring_python_sdk.type.subscription2 import Subscription2

class RequiredChangingthepriceordiscountforanactivesubscriptionRequest(TypedDict):
    subscriptions: typing.List[Subscription2]

class OptionalChangingthepriceordiscountforanactivesubscriptionRequest(TypedDict, total=False):
    pass

class ChangingthepriceordiscountforanactivesubscriptionRequest(RequiredChangingthepriceordiscountforanactivesubscriptionRequest, OptionalChangingthepriceordiscountforanactivesubscriptionRequest):
    pass
