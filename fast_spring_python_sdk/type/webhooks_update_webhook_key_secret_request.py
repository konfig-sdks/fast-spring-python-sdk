...
class RequiredWebhooksUpdateWebhookKeySecretRequest(TypedDict):
...
class OptionalWebhooksUpdateWebhookKeySecretRequest(TypedDict, total=False):
    pass

class WebhooksUpdateWebhookKeySecretRequest(RequiredWebhooksUpdateWebhookKeySecretRequest, OptionalWebhooksUpdateWebhookKeySecretRequest):
    pass
