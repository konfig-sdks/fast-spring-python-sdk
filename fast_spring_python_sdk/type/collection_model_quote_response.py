...
class RequiredCollectionModelQuoteResponse(TypedDict):
    pass

class OptionalCollectionModelQuoteResponse(TypedDict, total=False):
    links: typing.List[Link]

    content: typing.List[QuoteResponse]

class CollectionModelQuoteResponse(RequiredCollectionModelQuoteResponse, OptionalCollectionModelQuoteResponse):
    pass
