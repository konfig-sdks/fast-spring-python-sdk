...
class RequiredCreateanaccountRequest(TypedDict):
    contact: Contact
...
class OptionalCreateanaccountRequest(TypedDict, total=False):
    pass

class CreateanaccountRequest(RequiredCreateanaccountRequest, OptionalCreateanaccountRequest):
    pass
