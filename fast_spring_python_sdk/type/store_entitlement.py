...
from fast_spring_python_sdk.type.store_entitlement_roles import StoreEntitlementRoles

class RequiredStoreEntitlement(TypedDict):
    pass

class OptionalStoreEntitlement(TypedDict, total=False):
    siteId: str

    roles: StoreEntitlementRoles

class StoreEntitlement(RequiredStoreEntitlement, OptionalStoreEntitlement):
    pass
