...
class RequiredItemTaxResponse(TypedDict):
    pass

class OptionalItemTaxResponse(TypedDict, total=False):
    taxValue: typing.Union[int, float]

    totalTaxable: typing.Union[int, float]

class ItemTaxResponse(RequiredItemTaxResponse, OptionalItemTaxResponse):
    pass
