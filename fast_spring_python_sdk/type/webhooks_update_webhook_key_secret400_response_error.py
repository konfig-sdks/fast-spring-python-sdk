...
class RequiredWebhooksUpdateWebhookKeySecret400ResponseError(TypedDict):
    pass

class OptionalWebhooksUpdateWebhookKeySecret400ResponseError(TypedDict, total=False):
    url: str

    hmacSecret: typing.Union[str, str]

class WebhooksUpdateWebhookKeySecret400ResponseError(RequiredWebhooksUpdateWebhookKeySecret400ResponseError, OptionalWebhooksUpdateWebhookKeySecret400ResponseError):
    pass
