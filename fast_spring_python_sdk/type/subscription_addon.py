...
class RequiredSubscriptionAddon(TypedDict):
    pass

class OptionalSubscriptionAddon(TypedDict, total=False):
    product: str
...
class SubscriptionAddon(RequiredSubscriptionAddon, OptionalSubscriptionAddon):
    pass
