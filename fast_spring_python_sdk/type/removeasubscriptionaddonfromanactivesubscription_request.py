...
from fast_spring_python_sdk.type.subscription4 import Subscription4

class RequiredRemoveasubscriptionaddonfromanactivesubscriptionRequest(TypedDict):
    subscriptions: typing.List[Subscription4]

class OptionalRemoveasubscriptionaddonfromanactivesubscriptionRequest(TypedDict, total=False):
    pass

class RemoveasubscriptionaddonfromanactivesubscriptionRequest(RequiredRemoveasubscriptionaddonfromanactivesubscriptionRequest, OptionalRemoveasubscriptionaddonfromanactivesubscriptionRequest):
    pass
