...
class RequiredItemRenewalResponse(TypedDict):
    pass

class OptionalItemRenewalResponse(TypedDict, total=False):
    renewIntoProductId: str

    renewIntoPath: str

    renewIntoPrice: typing.Union[int, float]

    renewIntoPeriod: str

    renewIntoLevel: int

    renewIntoIntervalCount: str

    renewIntoUpcomingProduct: str

class ItemRenewalResponse(RequiredItemRenewalResponse, OptionalItemRenewalResponse):
    pass
