...
from fast_spring_python_sdk.type.subscription3 import Subscription3

class RequiredAddingoreditingasubscriptionaddontoanactivesubscriptionRequest(TypedDict):
    subscriptions: typing.List[Subscription3]

class OptionalAddingoreditingasubscriptionaddontoanactivesubscriptionRequest(TypedDict, total=False):
    pass

class AddingoreditingasubscriptionaddontoanactivesubscriptionRequest(RequiredAddingoreditingasubscriptionaddontoanactivesubscriptionRequest, OptionalAddingoreditingasubscriptionaddontoanactivesubscriptionRequest):
    pass
