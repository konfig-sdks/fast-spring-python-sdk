...
from fast_spring_python_sdk.type.amount2 import Amount2

class RequiredDiscount2(TypedDict):
    type: str
...
class OptionalDiscount2(TypedDict, total=False):
    pass

class Discount2(RequiredDiscount2, OptionalDiscount2):
    pass
