...
class RequiredCreateasessionwithoutoverridinganydefaultvaluesRequest(TypedDict):
    account: str

    items: typing.List[Item2]

class OptionalCreateasessionwithoutoverridinganydefaultvaluesRequest(TypedDict, total=False):
    pass

class CreateasessionwithoutoverridinganydefaultvaluesRequest(RequiredCreateasessionwithoutoverridinganydefaultvaluesRequest, OptionalCreateasessionwithoutoverridinganydefaultvaluesRequest):
    pass
