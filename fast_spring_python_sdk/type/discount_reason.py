...
class RequiredDiscountReason(TypedDict):
    en: str

class OptionalDiscountReason(TypedDict, total=False):
    pass

class DiscountReason(RequiredDiscountReason, OptionalDiscountReason):
    pass
