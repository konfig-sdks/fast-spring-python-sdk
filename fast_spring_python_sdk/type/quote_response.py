...
from fast_spring_python_sdk.type.address_response import AddressResponse
from fast_spring_python_sdk.type.contact_response import ContactResponse
from fast_spring_python_sdk.type.item_response import ItemResponse
from fast_spring_python_sdk.type.link import Link
from fast_spring_python_sdk.type.status_history_response import StatusHistoryResponse
from fast_spring_python_sdk.type.tag_response import TagResponse

class RequiredQuoteResponse(TypedDict):
    pass

class OptionalQuoteResponse(TypedDict, total=False):
    ...
    discountInPayoutCurrency: typing.Union[int, float]

    discountInPayoutCurrencyDisplay: str
    ...
    items: typing.List[ItemResponse]
    ...
    statusHistory: typing.List[StatusHistoryResponse]

    subtotal: typing.Union[int, float]

    subtotalDisplay: str

    subtotalInPayoutCurrency: typing.Union[int, float]

    subtotalInPayoutCurrencyDisplay: str
    ...
    totalInPayoutCurrency: typing.Union[int, float]

    totalInPayoutCurrencyDisplay: str
...
class QuoteResponse(RequiredQuoteResponse, OptionalQuoteResponse):
    pass
