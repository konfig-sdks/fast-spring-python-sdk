...
from fast_spring_python_sdk.type.price3 import Price3

class RequiredPricing3(TypedDict):
    price: Price3

class OptionalPricing3(TypedDict, total=False):
    pass

class Pricing3(RequiredPricing3, OptionalPricing3):
    pass
