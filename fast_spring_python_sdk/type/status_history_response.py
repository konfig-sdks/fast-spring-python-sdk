...
class RequiredStatusHistoryResponse(TypedDict):
    pass

class OptionalStatusHistoryResponse(TypedDict, total=False):
    statusUpdatedTo: str

    statusUpdatedByFullName: str

    statusUpdatedByEmail: str

    statusUpdatedOn: datetime

class StatusHistoryResponse(RequiredStatusHistoryResponse, OptionalStatusHistoryResponse):
    pass
