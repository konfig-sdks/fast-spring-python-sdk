...
class RequiredCreateQuoteRequest(TypedDict):
...
class OptionalCreateQuoteRequest(TypedDict, total=False):
...
class CreateQuoteRequest(RequiredCreateQuoteRequest, OptionalCreateQuoteRequest):
    pass
