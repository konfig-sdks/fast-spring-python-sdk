...
class RequiredUpdateasingleeventRequest(TypedDict):
    processed: bool

class OptionalUpdateasingleeventRequest(TypedDict, total=False):
    pass

class UpdateasingleeventRequest(RequiredUpdateasingleeventRequest, OptionalUpdateasingleeventRequest):
    pass
