...
class RequiredWebhooksUpdateWebhookKeySecretResponse(TypedDict):
    pass

class OptionalWebhooksUpdateWebhookKeySecretResponse(TypedDict, total=False):
    url: str
...
class WebhooksUpdateWebhookKeySecretResponse(RequiredWebhooksUpdateWebhookKeySecretResponse, OptionalWebhooksUpdateWebhookKeySecretResponse):
    pass
