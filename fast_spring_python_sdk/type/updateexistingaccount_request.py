...
from fast_spring_python_sdk.type.contact import Contact
from fast_spring_python_sdk.type.lookup import Lookup

class RequiredUpdateexistingaccountRequest(TypedDict):
    contact: Contact
...
class OptionalUpdateexistingaccountRequest(TypedDict, total=False):
    pass

class UpdateexistingaccountRequest(RequiredUpdateexistingaccountRequest, OptionalUpdateexistingaccountRequest):
    pass
