...
class RequiredCreateOneAccount(TypedDict):
    pass

class OptionalCreateOneAccount(TypedDict, total=False):
    contact: ContactRequest

class CreateOneAccount(RequiredCreateOneAccount, OptionalCreateOneAccount):
    pass
