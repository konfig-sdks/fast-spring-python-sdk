...
from fast_spring_python_sdk.type.entitlement import Entitlement
from fast_spring_python_sdk.type.user_principal_roles import UserPrincipalRoles
from fast_spring_python_sdk.type.user_principal_site_ids import UserPrincipalSiteIds

class RequiredUserPrincipal(TypedDict):
    pass

class OptionalUserPrincipal(TypedDict, total=False):
    email: str

    siteId: str

    siteIds: UserPrincipalSiteIds
    ...
    authProviderType: str

    accessToken: str

    tokenExpires: int

class UserPrincipal(RequiredUserPrincipal, OptionalUserPrincipal):
    pass
