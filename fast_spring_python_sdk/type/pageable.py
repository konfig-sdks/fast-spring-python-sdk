...
from fast_spring_python_sdk.type.sort import Sort

class RequiredPageable(TypedDict):
    pass

class OptionalPageable(TypedDict, total=False):
    offset: int
...
class Pageable(RequiredPageable, OptionalPageable):
    pass
