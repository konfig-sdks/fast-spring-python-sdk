...
class RequiredQuotesUpdateQuoteByIdRequest(TypedDict):
    pass

class OptionalQuotesUpdateQuoteByIdRequest(TypedDict, total=False):
    updateQuoteRequest: UpdateQuoteRequest

class QuotesUpdateQuoteByIdRequest(RequiredQuotesUpdateQuoteByIdRequest, OptionalQuotesUpdateQuoteByIdRequest):
    pass
