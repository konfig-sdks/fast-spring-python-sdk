...
class RequiredUpdateoneormoreexistingproductsRequest(TypedDict):
    products: typing.List[Product]

class OptionalUpdateoneormoreexistingproductsRequest(TypedDict, total=False):
    pass

class UpdateoneormoreexistingproductsRequest(RequiredUpdateoneormoreexistingproductsRequest, OptionalUpdateoneormoreexistingproductsRequest):
    pass
