...
from fast_spring_python_sdk.type.filter_subscription_report_request_country_iso import FilterSubscriptionReportRequestCountryIso
from fast_spring_python_sdk.type.filter_subscription_report_request_product_names import FilterSubscriptionReportRequestProductNames
from fast_spring_python_sdk.type.filter_subscription_report_request_product_paths import FilterSubscriptionReportRequestProductPaths

class RequiredFilterSubscriptionReportRequest(TypedDict):
    pass

class OptionalFilterSubscriptionReportRequest(TypedDict, total=False):
    startDate: date

    endDate: date

    countryISO: FilterSubscriptionReportRequestCountryIso

    productNames: FilterSubscriptionReportRequestProductNames

    productPaths: FilterSubscriptionReportRequestProductPaths

    syncDate: date

class FilterSubscriptionReportRequest(RequiredFilterSubscriptionReportRequest, OptionalFilterSubscriptionReportRequest):
    pass
