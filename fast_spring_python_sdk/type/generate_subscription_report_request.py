...
RequiredGenerateSubscriptionReportRequest = TypedDict("RequiredGenerateSubscriptionReportRequest", {
    })

OptionalGenerateSubscriptionReportRequest = TypedDict("OptionalGenerateSubscriptionReportRequest", {
    "filter": FilterSubscriptionReportRequest,

    "reportColumns": GenerateSubscriptionReportRequestReportColumns,

    "groupBy": GenerateSubscriptionReportRequestGroupBy,
    ...
    "notificationEmails": GenerateSubscriptionReportRequestNotificationEmails,
    }, total=False)

class GenerateSubscriptionReportRequest(RequiredGenerateSubscriptionReportRequest, OptionalGenerateSubscriptionReportRequest):
    pass
