...
class RequiredContactRequest(TypedDict):
    email: str
...
class OptionalContactRequest(TypedDict, total=False):
    company: str

    phone: str

class ContactRequest(RequiredContactRequest, OptionalContactRequest):
    pass
