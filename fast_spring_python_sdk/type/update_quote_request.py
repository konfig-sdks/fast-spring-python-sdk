...
class RequiredUpdateQuoteRequest(TypedDict):
    currency: str
...
class OptionalUpdateQuoteRequest(TypedDict, total=False):
    tags: typing.List[TagRequest]
...
class UpdateQuoteRequest(RequiredUpdateQuoteRequest, OptionalUpdateQuoteRequest):
    pass
