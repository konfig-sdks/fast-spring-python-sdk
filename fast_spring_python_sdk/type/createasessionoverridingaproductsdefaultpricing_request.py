...
from fast_spring_python_sdk.type.item3 import Item3

class RequiredCreateasessionoverridingaproductsdefaultpricingRequest(TypedDict):
    account: str

    items: typing.List[Item3]

class OptionalCreateasessionoverridingaproductsdefaultpricingRequest(TypedDict, total=False):
    pass

class CreateasessionoverridingaproductsdefaultpricingRequest(RequiredCreateasessionoverridingaproductsdefaultpricingRequest, OptionalCreateasessionoverridingaproductsdefaultpricingRequest):
    pass
