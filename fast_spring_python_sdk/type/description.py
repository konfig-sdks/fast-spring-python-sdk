...
from fast_spring_python_sdk.type.action import Action
from fast_spring_python_sdk.type.full import Full
from fast_spring_python_sdk.type.summary import Summary

class RequiredDescription(TypedDict):
    summary: Summary
...
class OptionalDescription(TypedDict, total=False):
    pass

class Description(RequiredDescription, OptionalDescription):
    pass
