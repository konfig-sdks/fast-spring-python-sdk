...
from fast_spring_python_sdk.type.pricing3 import Pricing3

class RequiredItem3(TypedDict):
    product: str
...
class OptionalItem3(TypedDict, total=False):
    pass

class Item3(RequiredItem3, OptionalItem3):
    pass
