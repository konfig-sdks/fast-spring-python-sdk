...
from fast_spring_python_sdk.type.discount3 import Discount3
from fast_spring_python_sdk.type.price4 import Price4

class RequiredPricing5(TypedDict):
    price: Price4

    discount: Discount3

class OptionalPricing5(TypedDict, total=False):
    pass

class Pricing5(RequiredPricing5, OptionalPricing5):
    pass
