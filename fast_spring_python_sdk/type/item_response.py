...
from fast_spring_python_sdk.type.item_renewal_response import ItemRenewalResponse
from fast_spring_python_sdk.type.item_tax_response import ItemTaxResponse

class RequiredItemResponse(TypedDict):
    pass

class OptionalItemResponse(TypedDict, total=False):
    product: str
    ...
    renewIntoProducts: typing.List[ItemRenewalResponse]

    taxes: typing.List[ItemTaxResponse]
    ...
    unitCouponDiscount: typing.Union[int, float]

    unitCouponDiscountDisplay: str

    unitCouponDiscountInPayoutCurrency: typing.Union[int, float]

    unitCouponDiscountInPayoutCurrencyDisplay: str

    unitDiscount: typing.Union[int, float]

    unitDiscountDisplay: str

    unitDiscountInPayoutCurrency: typing.Union[int, float]

    unitDiscountInPayoutCurrencyDisplay: str

    unitListPrice: typing.Union[int, float]

    unitListPriceDisplay: str

    unitListPriceInPayoutCurrency: typing.Union[int, float]

    unitListPriceInPayoutCurrencyDisplay: str

    unitPrice: typing.Union[int, float]

    unitPriceDisplay: str

    unitPriceInPayoutCurrency: typing.Union[int, float]

    unitPriceInPayoutCurrencyDisplay: str

    unitPriceWithoutTax: typing.Union[int, float]

    unitPriceWithoutTaxDisplay: str

    unitListPriceWithoutTax: typing.Union[int, float]

    unitListPriceWithoutTaxDisplay: str

class ItemResponse(RequiredItemResponse, OptionalItemResponse):
    pass
