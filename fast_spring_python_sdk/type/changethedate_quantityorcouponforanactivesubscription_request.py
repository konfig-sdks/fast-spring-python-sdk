...
from fast_spring_python_sdk.type.subscription1 import Subscription1

class RequiredChangethedateQuantityorcouponforanactivesubscriptionRequest(TypedDict):
    subscriptions: typing.List[Subscription1]

class OptionalChangethedateQuantityorcouponforanactivesubscriptionRequest(TypedDict, total=False):
    pass

class ChangethedateQuantityorcouponforanactivesubscriptionRequest(RequiredChangethedateQuantityorcouponforanactivesubscriptionRequest, OptionalChangethedateQuantityorcouponforanactivesubscriptionRequest):
    pass
