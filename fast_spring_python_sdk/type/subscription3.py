...
from fast_spring_python_sdk.type.addon import Addon

class RequiredSubscription3(TypedDict):
    subscription: str

    addons: typing.List[Addon]

class OptionalSubscription3(TypedDict, total=False):
    pass

class Subscription3(RequiredSubscription3, OptionalSubscription3):
    pass
