...
from fast_spring_python_sdk.type.filter_revenue_report_request_country_iso import FilterRevenueReportRequestCountryIso
from fast_spring_python_sdk.type.filter_revenue_report_request_product_names import FilterRevenueReportRequestProductNames
from fast_spring_python_sdk.type.filter_revenue_report_request_product_paths import FilterRevenueReportRequestProductPaths

class RequiredFilterRevenueReportRequest(TypedDict):
    pass

class OptionalFilterRevenueReportRequest(TypedDict, total=False):
    startDate: date

    endDate: date

    countryISO: FilterRevenueReportRequestCountryIso

    productNames: FilterRevenueReportRequestProductNames

    productPaths: FilterRevenueReportRequestProductPaths

    syncDate: date

class FilterRevenueReportRequest(RequiredFilterRevenueReportRequest, OptionalFilterRevenueReportRequest):
    pass
