...
class RequiredChangetheproductforanactivesubscriptionRequest(TypedDict):
    subscriptions: typing.List[Subscription]

class OptionalChangetheproductforanactivesubscriptionRequest(TypedDict, total=False):
    pass

class ChangetheproductforanactivesubscriptionRequest(RequiredChangetheproductforanactivesubscriptionRequest, OptionalChangetheproductforanactivesubscriptionRequest):
    pass
