...
from fast_spring_python_sdk.type.order import Order

class RequiredUpdateordertagsandattributesRequest(TypedDict):
    orders: typing.List[Order]

class OptionalUpdateordertagsandattributesRequest(TypedDict, total=False):
    pass

class UpdateordertagsandattributesRequest(RequiredUpdateordertagsandattributesRequest, OptionalUpdateordertagsandattributesRequest):
    pass
