...
class RequiredAddressResponse(TypedDict):
    pass

class OptionalAddressResponse(TypedDict, total=False):
    addressLine1: str
...
class AddressResponse(RequiredAddressResponse, OptionalAddressResponse):
    pass
