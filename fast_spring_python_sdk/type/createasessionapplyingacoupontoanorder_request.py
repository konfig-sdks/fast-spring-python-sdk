...
class RequiredCreateasessionapplyingacoupontoanorderRequest(TypedDict):
    account: str
...
class OptionalCreateasessionapplyingacoupontoanorderRequest(TypedDict, total=False):
    pass

class CreateasessionapplyingacoupontoanorderRequest(RequiredCreateasessionapplyingacoupontoanorderRequest, OptionalCreateasessionapplyingacoupontoanorderRequest):
    pass
