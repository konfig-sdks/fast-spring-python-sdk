...
from fast_spring_python_sdk.type.subscription5 import Subscription5

class RequiredChangeasubscriptionfromautomaticrenewaltomanualRequest(TypedDict):
    subscriptions: typing.List[Subscription5]

class OptionalChangeasubscriptionfromautomaticrenewaltomanualRequest(TypedDict, total=False):
    pass

class ChangeasubscriptionfromautomaticrenewaltomanualRequest(RequiredChangeasubscriptionfromautomaticrenewaltomanualRequest, OptionalChangeasubscriptionfromautomaticrenewaltomanualRequest):
    pass
