...
class RequiredPauseSubscriptionRequest(TypedDict):
    pass

class OptionalPauseSubscriptionRequest(TypedDict, total=False):
    pausePeriodCount: int

class PauseSubscriptionRequest(RequiredPauseSubscriptionRequest, OptionalPauseSubscriptionRequest):
    pass
