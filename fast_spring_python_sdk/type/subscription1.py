...
from fast_spring_python_sdk.type.subscription1_coupons import Subscription1Coupons

class RequiredSubscription1(TypedDict):
    subscription: str
...
class OptionalSubscription1(TypedDict, total=False):
    pass

class Subscription1(RequiredSubscription1, OptionalSubscription1):
    pass
