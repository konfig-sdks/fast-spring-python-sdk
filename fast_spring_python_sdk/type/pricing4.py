...
from fast_spring_python_sdk.type.discount2 import Discount2
from fast_spring_python_sdk.type.price4 import Price4

class RequiredPricing4(TypedDict):
    price: Price4

    discount: Discount2

class OptionalPricing4(TypedDict, total=False):
    pass

class Pricing4(RequiredPricing4, OptionalPricing4):
    pass
