...
from fast_spring_python_sdk.client_custom import ClientCustom
from fast_spring_python_sdk.configuration import Configuration
from fast_spring_python_sdk.api_client import ApiClient
from fast_spring_python_sdk.type_util import copy_signature
...
class FastSpring(ClientCustom):
    ...
    def __init__(self, configuration: typing.Union[Configuration, None] = None, **kwargs):
        ...
        self.coupons: CouponsApi = CouponsApi(api_client)
        self.data: DataApi = DataApi(api_client)
        ...
        self.quotes: QuotesApi = QuotesApi(api_client)
        self.returns: ReturnsApi = ReturnsApi(api_client)
