...
class BaseApi(api_client.Api):
    ...
    def _convert_expired_trial_without_payment_method_mapped_args(
        self,
        subscription_id: str,
    ...
    async def _aconvert_expired_trial_without_payment_method_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/subscriptions/{subscription_id}/convert',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _convert_expired_trial_without_payment_method_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ConvertExpiredTrialWithoutPaymentMethodRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aconvert_expired_trial_without_payment_method(
        self,
        subscription_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._convert_expired_trial_without_payment_method_mapped_args(
            subscription_id=subscription_id,
        )
        return await self._aconvert_expired_trial_without_payment_method_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def convert_expired_trial_without_payment_method(
        self,
        subscription_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._convert_expired_trial_without_payment_method_oapg(
            path_params=args.path,
        )

class ConvertExpiredTrialWithoutPaymentMethod(BaseApi):
    ...
    async def aconvert_expired_trial_without_payment_method(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aconvert_expired_trial_without_payment_method(
            subscription_id=subscription_id,
            **kwargs,
        )
        if validate:
    ...
    def convert_expired_trial_without_payment_method(
        ...
        raw_response = self.raw.convert_expired_trial_without_payment_method(
            subscription_id=subscription_id,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
