...
class BaseApi(api_client.Api):
    ...
    def _get_price_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_price_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/price/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetPriceByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_price_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_price_by_id_mapped_args(
            id=id,
        )
        return await self._aget_price_by_id_oapg(
    ...
    def get_price_by_id(
        ...
        return self._get_price_by_id_oapg(
            path_params=args.path,
        )

class GetPriceById(BaseApi):
    ...
    async def aget_price_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_price_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_price_by_id(
        ...
        raw_response = self.raw.get_price_by_id(
            id=id,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
