...
class BaseApi(api_client.Api):
    ...
    def _get_account_by_id_mapped_args(
        self,
        account_id: str,
    ...
    async def _aget_account_by_id_oapg(
        self,
...
class GetAccountByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_account_by_id(
        self,
        account_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_account_by_id_mapped_args(
            account_id=account_id,
        )
        return await self._aget_account_by_id_oapg(
    ...
    def get_account_by_id(
        ...
        return self._get_account_by_id_oapg(
            path_params=args.path,
        )

class GetAccountById(BaseApi):
    ...
    async def aget_account_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_account_by_id(
            account_id=account_id,
            **kwargs,
        )
        if validate:
    ...
    def get_account_by_id(
        ...
        raw_response = self.raw.get_account_by_id(
            account_id=account_id,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
