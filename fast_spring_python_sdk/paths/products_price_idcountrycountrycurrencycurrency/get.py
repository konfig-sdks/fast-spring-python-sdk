...
class BaseApi(api_client.Api):
    ...
    def _get_product_price_by_country_and_currency_mapped_args(
        self,
        id: str,
        country: str,
        currency: str,
    ...
    async def _aget_product_price_by_country_and_currency_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/price/{id}?country={country}&currency={currency}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_product_price_by_country_and_currency_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetProductPriceByCountryAndCurrencyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_product_price_by_country_and_currency(
        self,
        id: str,
        country: str,
        currency: str,
        **kwargs,
        ...
        args = self._get_product_price_by_country_and_currency_mapped_args(
            id=id,
            country=country,
            currency=currency,
        )
        return await self._aget_product_price_by_country_and_currency_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_product_price_by_country_and_currency(
        self,
        id: str,
        country: str,
        currency: str,
        ...
        return self._get_product_price_by_country_and_currency_oapg(
            path_params=args.path,
        )

class GetProductPriceByCountryAndCurrency(BaseApi):
    ...
    async def aget_product_price_by_country_and_currency(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_product_price_by_country_and_currency(
            id=id,
            country=country,
            currency=currency,
            **kwargs,
    ...
    def get_product_price_by_country_and_currency(
        ...
        raw_response = self.raw.get_product_price_by_country_and_currency(
            id=id,
            country=country,
            currency=currency,
        )
