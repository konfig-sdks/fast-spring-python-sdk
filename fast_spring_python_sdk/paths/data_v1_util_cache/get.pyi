...
class BaseApi(api_client.Api):
    ...
    def _reset_cache_for_service_end_points_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _areset_cache_for_service_end_points_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/data/v1/util/cache',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _reset_cache_for_service_end_points_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class ResetCacheForServiceEndPointsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areset_cache_for_service_end_points(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._reset_cache_for_service_end_points_mapped_args(
        )
        return await self._areset_cache_for_service_end_points_oapg(
            **kwargs,
        )
    
    def reset_cache_for_service_end_points(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._reset_cache_for_service_end_points_oapg(
        )

class ResetCacheForServiceEndPoints(BaseApi):
    ...
    async def areset_cache_for_service_end_points(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areset_cache_for_service_end_points(
            **kwargs,
        )
        if validate:
    ...
    def reset_cache_for_service_end_points(
        ...
        raw_response = self.raw.reset_cache_for_service_end_points(
        )
        if validate:
            return RootModel[str](raw_response.body).root
        return raw_response.body
