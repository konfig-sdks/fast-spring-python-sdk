...
class BaseApi(api_client.Api):
    ...
    def _rebill_managed_subscription_mapped_args(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
    ...
    async def _arebill_managed_subscription_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/subscriptions/charge',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _rebill_managed_subscription_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RebillManagedSubscriptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arebill_managed_subscription(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._rebill_managed_subscription_mapped_args(
            body=body,
        )
        return await self._arebill_managed_subscription_oapg(
            body=args.body,
            **kwargs,
        )
    
    def rebill_managed_subscription(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._rebill_managed_subscription_oapg(
            body=args.body,
        )

class RebillManagedSubscription(BaseApi):
    ...
    async def arebill_managed_subscription(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arebill_managed_subscription(
            body=body,
            **kwargs,
        )
        if validate:
    ...
    def rebill_managed_subscription(
        ...
        raw_response = self.raw.rebill_managed_subscription(
            body=body,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
