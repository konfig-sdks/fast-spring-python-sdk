...
class BaseApi(api_client.Api):
    ...
    def _cancel_quote_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _acancel_quote_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/quotes/{id}/cancel',
            auth_settings=_auth,
            headers=_headers,
        )
...
class CancelQuoteByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_quote_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._cancel_quote_by_id_mapped_args(
            id=id,
        )
        return await self._acancel_quote_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def cancel_quote_by_id(
        self,
        id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._cancel_quote_by_id_oapg(
            path_params=args.path,
        )

class CancelQuoteById(BaseApi):
    ...
    async def acancel_quote_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_quote_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def cancel_quote_by_id(
        ...
        raw_response = self.raw.cancel_quote_by_id(
            id=id,
        )
        if validate:
            return QuoteResponsePydantic(**raw_response.body)
