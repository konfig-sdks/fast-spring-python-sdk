...
class BaseApi(api_client.Api):
    ...
    def _remove_scheduled_pause_mapped_args(
        self,
        subscription_id: str,
    ...
    async def _aremove_scheduled_pause_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/subscriptions/{subscription_id}/resume',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _remove_scheduled_pause_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveScheduledPauseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_scheduled_pause(
        self,
        subscription_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_scheduled_pause_mapped_args(
            subscription_id=subscription_id,
        )
        return await self._aremove_scheduled_pause_oapg(
    ...
    def remove_scheduled_pause(
        ...
        return self._remove_scheduled_pause_oapg(
            path_params=args.path,
        )

class RemoveScheduledPause(BaseApi):
    ...
    async def aremove_scheduled_pause(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_scheduled_pause(
            subscription_id=subscription_id,
            **kwargs,
        )
        if validate:
    ...
    def remove_scheduled_pause(
        ...
        raw_response = self.raw.remove_scheduled_pause(
            subscription_id=subscription_id,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
