...
class BaseApi(api_client.Api):
    ...
    def _get_job_information_0_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_job_information_0_oapg(
        self,
    ...
    def _get_job_information_0_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetJobInformation0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_job_information_0(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_job_information_0_mapped_args(
        )
        return await self._aget_job_information_0_oapg(
            **kwargs,
        )
    
    def get_job_information_0(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._get_job_information_0_oapg(
        )

class GetJobInformation0(BaseApi):
    ...
    async def aget_job_information_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_job_information_0(
            **kwargs,
        )
        if validate:
    ...
    def get_job_information_0(
        ...
        raw_response = self.raw.get_job_information_0(
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
        return raw_response.body
