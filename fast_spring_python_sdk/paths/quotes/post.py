...
from fast_spring_python_sdk.model.contact_request import ContactRequest as ContactRequestSchema
from fast_spring_python_sdk.model.quote_response import QuoteResponse as QuoteResponseSchema
from fast_spring_python_sdk.model.tag_request import TagRequest as TagRequestSchema
from fast_spring_python_sdk.model.address_request import AddressRequest as AddressRequestSchema
from fast_spring_python_sdk.model.create_quote_request import CreateQuoteRequest as CreateQuoteRequestSchema
from fast_spring_python_sdk.model.item_request import ItemRequest as ItemRequestSchema

from fast_spring_python_sdk.type.quote_response import QuoteResponse
from fast_spring_python_sdk.type.contact_request import ContactRequest
from fast_spring_python_sdk.type.address_request import AddressRequest
from fast_spring_python_sdk.type.tag_request import TagRequest
from fast_spring_python_sdk.type.create_quote_request import CreateQuoteRequest
from fast_spring_python_sdk.type.item_request import ItemRequest

from ...api_client import Dictionary
from fast_spring_python_sdk.pydantic.tag_request import TagRequest as TagRequestPydantic
from fast_spring_python_sdk.pydantic.contact_request import ContactRequest as ContactRequestPydantic
from fast_spring_python_sdk.pydantic.item_request import ItemRequest as ItemRequestPydantic
from fast_spring_python_sdk.pydantic.quote_response import QuoteResponse as QuoteResponsePydantic
from fast_spring_python_sdk.pydantic.address_request import AddressRequest as AddressRequestPydantic
from fast_spring_python_sdk.pydantic.create_quote_request import CreateQuoteRequest as CreateQuoteRequestPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateQuoteRequestSchema


request_body_create_quote_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = QuoteResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_quote_mapped_args(
        self,
        items: typing.List[ItemRequest],
        name: str,
        recipient_address: AddressRequest,
        recipient: ContactRequest,
        tags: typing.Optional[typing.List[TagRequest]] = None,
        coupon: typing.Optional[str] = None,
        currency: typing.Optional[str] = None,
        expiration_date_days: typing.Optional[int] = None,
        fulfillment_term: typing.Optional[str] = None,
        notes: typing.Optional[str] = None,
        net_terms_days: typing.Optional[int] = None,
        ...
        if expiration_date_days is not None:
            _body["expirationDateDays"] = expiration_date_days
        if fulfillment_term is not None:
            _body["fulfillmentTerm"] = fulfillment_term
        ...
        if net_terms_days is not None:
            _body["netTermsDays"] = net_terms_days
        if recipient_address is not None:
            _body["recipientAddress"] = recipient_address
        ...
        if source_ip is not None:
            _body["sourceIP"] = source_ip
        args.body = _body
        return args

    async def _acreate_new_quote_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_quote_request.serialize(body, content_type)
...
class CreateNewQuoteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_quote(
        self,
        items: typing.List[ItemRequest],
        name: str,
        recipient_address: AddressRequest,
        ...
        **kwargs,
        ...
        args = self._create_new_quote_mapped_args(
            items=items,
            name=name,
            ...
            coupon=coupon,
            currency=currency,
            expiration_date_days=expiration_date_days,
        ...
        return await self._acreate_new_quote_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_quote(
        ...
        return self._create_new_quote_oapg(
            body=args.body,
        )

class CreateNewQuote(BaseApi):
    ...
    async def acreate_new_quote(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_quote(
            items=items,
            name=name,
            recipient_address=recipient_address,
            recipient=recipient,
    ...
    def create_new_quote(
        ...
        raw_response = self.raw.create_new_quote(
            items=items,
            name=name,
            recipient_address=recipient_address,
            recipient=recipient,
