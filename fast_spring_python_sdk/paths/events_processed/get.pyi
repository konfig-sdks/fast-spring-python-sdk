...
# Query params
DaysSchema = schemas.Int32Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_processed_events_mapped_args(
        self,
        days: int,
    ...
    async def _aget_processed_events_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/events/processed',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_processed_events_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetProcessedEventsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_processed_events(
        self,
        days: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_processed_events_mapped_args(
            days=days,
        )
        return await self._aget_processed_events_oapg(
    ...
    def get_processed_events(
        ...
        return self._get_processed_events_oapg(
            query_params=args.query,
        )

class GetProcessedEvents(BaseApi):
    ...
    async def aget_processed_events(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_processed_events(
            days=days,
            **kwargs,
        )
        if validate:
    ...
    def get_processed_events(
        ...
        raw_response = self.raw.get_processed_events(
            days=days,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
