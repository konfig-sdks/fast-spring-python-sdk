...
class BaseApi(api_client.Api):
    ...
    def _get_product_price_by_country_mapped_args(
        self,
        id: str,
        country: str,
    ...
    async def _aget_product_price_by_country_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/price/{id}?country={country}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_product_price_by_country_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetProductPriceByCountryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_product_price_by_country(
        self,
        id: str,
        country: str,
        **kwargs,
        ...
        args = self._get_product_price_by_country_mapped_args(
            id=id,
            country=country,
        )
        return await self._aget_product_price_by_country_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_product_price_by_country(
        self,
        id: str,
        country: str,
    ) -> typing.Union[
        ...
        return self._get_product_price_by_country_oapg(
            path_params=args.path,
        )

class GetProductPriceByCountry(BaseApi):
    ...
    async def aget_product_price_by_country(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_product_price_by_country(
            id=id,
            country=country,
            **kwargs,
        )
    ...
    def get_product_price_by_country(
        ...
        raw_response = self.raw.get_product_price_by_country(
            id=id,
            country=country,
        )
        if validate:
