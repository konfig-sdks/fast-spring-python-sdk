...
class BaseApi(api_client.Api):
    ...
    def _create_new_coupon_mapped_args(
        self,
    ...
    async def _acreate_new_coupon_oapg(
        self,
...
class CreateNewCouponRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_coupon(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._create_new_coupon_mapped_args(
            body=body,
        )
        return await self._acreate_new_coupon_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_coupon(
        ...
        return self._create_new_coupon_oapg(
            body=args.body,
        )

class CreateNewCoupon(BaseApi):
    ...
    async def acreate_new_coupon(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_coupon(
            body=body,
            **kwargs,
        )
    ...
    def create_new_coupon(
        ...
        raw_response = self.raw.create_new_coupon(
            body=body,
        )
