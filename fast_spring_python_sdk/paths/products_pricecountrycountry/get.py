...
class BaseApi(api_client.Api):
    ...
    def _get_all_product_prices_by_country_mapped_args(
        self,
        country: str,
    ...
    async def _aget_all_product_prices_by_country_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/price?country={country}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_all_product_prices_by_country_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAllProductPricesByCountryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_product_prices_by_country(
        self,
        country: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_all_product_prices_by_country_mapped_args(
            country=country,
        )
        return await self._aget_all_product_prices_by_country_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_all_product_prices_by_country(
        self,
        country: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_all_product_prices_by_country_oapg(
            path_params=args.path,
        )

class GetAllProductPricesByCountry(BaseApi):
    ...
    async def aget_all_product_prices_by_country(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_product_prices_by_country(
            country=country,
            **kwargs,
        )
        if validate:
    ...
    def get_all_product_prices_by_country(
        ...
        raw_response = self.raw.get_all_product_prices_by_country(
            country=country,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
