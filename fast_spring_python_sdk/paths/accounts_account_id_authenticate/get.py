...
class BaseApi(api_client.Api):
    ...
    def _get_authenticated_management_url_mapped_args(
        self,
        account_id: str,
    ...
    async def _aget_authenticated_management_url_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/accounts/{account_id}/authenticate',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_authenticated_management_url_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAuthenticatedManagementUrlRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_authenticated_management_url(
        self,
        account_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_authenticated_management_url_mapped_args(
            account_id=account_id,
        )
        return await self._aget_authenticated_management_url_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_authenticated_management_url(
        self,
        account_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_authenticated_management_url_oapg(
            path_params=args.path,
        )

class GetAuthenticatedManagementUrl(BaseApi):
    ...
    async def aget_authenticated_management_url(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_authenticated_management_url(
            account_id=account_id,
            **kwargs,
        )
        if validate:
    ...
    def get_authenticated_management_url(
        ...
        raw_response = self.raw.get_authenticated_management_url(
            account_id=account_id,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
