...
class BaseApi(api_client.Api):
    ...
    def _get_all_product_ids_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_all_product_ids_oapg(
        self,
...
class GetAllProductIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_product_ids(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_all_product_ids_mapped_args(
        )
        return await self._aget_all_product_ids_oapg(
            **kwargs,
        )
    ...
    def get_all_product_ids(
        ...
        return self._get_all_product_ids_oapg(
        )

class GetAllProductIds(BaseApi):
    ...
    async def aget_all_product_ids(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_product_ids(
            **kwargs,
        )
        if validate:
    ...
    def get_all_product_ids(
        ...
        raw_response = self.raw.get_all_product_ids(
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
        return raw_response.body
