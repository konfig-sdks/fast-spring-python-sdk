...
from fast_spring_python_sdk.model.item2 import Item2 as Item2Schema
from fast_spring_python_sdk.model.createasessionwithoutoverridinganydefaultvalues_request import CreateasessionwithoutoverridinganydefaultvaluesRequest as CreateasessionwithoutoverridinganydefaultvaluesRequestSchema

from fast_spring_python_sdk.type.item2 import Item2
from fast_spring_python_sdk.type.createasessionwithoutoverridinganydefaultvalues_request import CreateasessionwithoutoverridinganydefaultvaluesRequest

from ...api_client import Dictionary
from fast_spring_python_sdk.pydantic.createasessionwithoutoverridinganydefaultvalues_request import CreateasessionwithoutoverridinganydefaultvaluesRequest as CreateasessionwithoutoverridinganydefaultvaluesRequestPydantic
from fast_spring_python_sdk.pydantic.item2 import Item2 as Item2Pydantic

# body param
SchemaForRequestBodyApplicationJson = CreateasessionwithoutoverridinganydefaultvaluesRequestSchema


request_body_createasessionwithoutoverridinganydefaultvalues_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_session_mapped_args(
        self,
        account: str,
        items: typing.List[Item2],
    ...
    async def _acreate_new_session_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_createasessionwithoutoverridinganydefaultvalues_request.serialize(body, content_type)
...
class CreateNewSessionRaw(BaseApi):
    ...
    async def acreate_new_session(
        ...
        **kwargs,
        ...
        args = self._create_new_session_mapped_args(
            account=account,
            items=items,
        )
        return await self._acreate_new_session_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_session(
        ...
        return self._create_new_session_oapg(
            body=args.body,
        )

class CreateNewSession(BaseApi):
    ...
    async def acreate_new_session(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_session(
            account=account,
            items=items,
            **kwargs,
        )
    ...
    def create_new_session(
        ...
        raw_response = self.raw.create_new_session(
            account=account,
            items=items,
        )
        if validate:
