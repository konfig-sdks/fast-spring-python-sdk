...
class BaseApi(api_client.Api):
    ...
    def _get_by_end_date_mapped_args(
        self,
        end_date: str,
    ...
    async def _aget_by_end_date_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orders?end={end_date}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByEndDateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_end_date(
        self,
        end_date: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_by_end_date_mapped_args(
            end_date=end_date,
        )
        return await self._aget_by_end_date_oapg(
    ...
    def get_by_end_date(
        ...
        return self._get_by_end_date_oapg(
            path_params=args.path,
        )

class GetByEndDate(BaseApi):
    ...
    async def aget_by_end_date(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_end_date(
            end_date=end_date,
            **kwargs,
        )
        if validate:
    ...
    def get_by_end_date(
        ...
        raw_response = self.raw.get_by_end_date(
            end_date=end_date,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
