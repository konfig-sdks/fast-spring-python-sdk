...
from fast_spring_python_sdk.model.products_create_or_update_offers_response import ProductsCreateOrUpdateOffersResponse as ProductsCreateOrUpdateOffersResponseSchema

from fast_spring_python_sdk.type.products_create_or_update_offers_response import ProductsCreateOrUpdateOffersResponse

from ...api_client import Dictionary
from fast_spring_python_sdk.pydantic.products_create_or_update_offers_response import ProductsCreateOrUpdateOffersResponse as ProductsCreateOrUpdateOffersResponsePydantic

# Path params
ProductPathSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'product_path': typing.Union[ProductPathSchema, str, ],
    }
)
...
request_path_product_path = api_client.PathParameter(
    name="product_path",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProductPathSchema,
    required=True,
)
# body param
...
SchemaFor200ResponseBodyApplicationJson = ProductsCreateOrUpdateOffersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProductsCreateOrUpdateOffersResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_or_update_offers_mapped_args(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        product_path: str,
        ...
        if product_path is not None:
            _path_params["product_path"] = product_path
        args.path = _path_params
        return args

    async def _acreate_or_update_offers_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/offers/{product_path}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _create_or_update_offers_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateOrUpdateOffersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_or_update_offers(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        product_path: str,
        **kwargs,
        ...
        args = self._create_or_update_offers_mapped_args(
            body=body,
            product_path=product_path,
        )
        return await self._acreate_or_update_offers_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_or_update_offers(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        product_path: str,
    ) -> typing.Union[
        ...
        return self._create_or_update_offers_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateOrUpdateOffers(BaseApi):
    ...
    async def acreate_or_update_offers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProductsCreateOrUpdateOffersResponsePydantic:
        raw_response = await self.raw.acreate_or_update_offers(
            body=body,
            product_path=product_path,
            **kwargs,
        )
        if validate:
            return RootModel[ProductsCreateOrUpdateOffersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ProductsCreateOrUpdateOffersResponsePydantic, raw_response.body)
    ...
    def create_or_update_offers(
        ...
        raw_response = self.raw.create_or_update_offers(
            body=body,
            product_path=product_path,
        )
        if validate:
