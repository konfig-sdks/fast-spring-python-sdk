...
from fast_spring_python_sdk.model.webhooks_update_webhook_key_secret_response import WebhooksUpdateWebhookKeySecretResponse as WebhooksUpdateWebhookKeySecretResponseSchema
from fast_spring_python_sdk.model.webhooks_update_webhook_key_secret400_response import WebhooksUpdateWebhookKeySecret400Response as WebhooksUpdateWebhookKeySecret400ResponseSchema
from fast_spring_python_sdk.model.webhooks_update_webhook_key_secret_request import WebhooksUpdateWebhookKeySecretRequest as WebhooksUpdateWebhookKeySecretRequestSchema

from fast_spring_python_sdk.type.webhooks_update_webhook_key_secret_response import WebhooksUpdateWebhookKeySecretResponse
from fast_spring_python_sdk.type.webhooks_update_webhook_key_secret_request import WebhooksUpdateWebhookKeySecretRequest
from fast_spring_python_sdk.type.webhooks_update_webhook_key_secret400_response import WebhooksUpdateWebhookKeySecret400Response

from ...api_client import Dictionary
from fast_spring_python_sdk.pydantic.webhooks_update_webhook_key_secret_response import WebhooksUpdateWebhookKeySecretResponse as WebhooksUpdateWebhookKeySecretResponsePydantic
from fast_spring_python_sdk.pydantic.webhooks_update_webhook_key_secret400_response import WebhooksUpdateWebhookKeySecret400Response as WebhooksUpdateWebhookKeySecret400ResponsePydantic
from fast_spring_python_sdk.pydantic.webhooks_update_webhook_key_secret_request import WebhooksUpdateWebhookKeySecretRequest as WebhooksUpdateWebhookKeySecretRequestPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = WebhooksUpdateWebhookKeySecretRequestSchema


request_body_webhooks_update_webhook_key_secret_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WebhooksUpdateWebhookKeySecretResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksUpdateWebhookKeySecretResponse
...
SchemaFor400ResponseBodyApplicationJson = WebhooksUpdateWebhookKeySecret400ResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: WebhooksUpdateWebhookKeySecret400Response
...
class BaseApi(api_client.Api):
    ...
    def _update_webhook_key_secret_mapped_args(
        self,
        url: str,
        hmac_secret: str,
        ...
        if hmac_secret is not None:
            _body["hmacSecret"] = hmac_secret
        args.body = _body
        return args

    async def _aupdate_webhook_key_secret_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/webhooks/keys',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_webhooks_update_webhook_key_secret_request.serialize(body, content_type)
    ...
    def _update_webhook_key_secret_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateWebhookKeySecretRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_webhook_key_secret(
        self,
        url: str,
        hmac_secret: str,
        **kwargs,
        ...
        args = self._update_webhook_key_secret_mapped_args(
            url=url,
            hmac_secret=hmac_secret,
        )
        return await self._aupdate_webhook_key_secret_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_webhook_key_secret(
        self,
        url: str,
        hmac_secret: str,
    ) -> typing.Union[
        ...
        return self._update_webhook_key_secret_oapg(
            body=args.body,
        )

class UpdateWebhookKeySecret(BaseApi):
    ...
    async def aupdate_webhook_key_secret(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksUpdateWebhookKeySecretResponsePydantic:
        raw_response = await self.raw.aupdate_webhook_key_secret(
            url=url,
            hmac_secret=hmac_secret,
            **kwargs,
        )
        if validate:
            return WebhooksUpdateWebhookKeySecretResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksUpdateWebhookKeySecretResponsePydantic, raw_response.body)
    ...
    def update_webhook_key_secret(
        ...
        raw_response = self.raw.update_webhook_key_secret(
            url=url,
            hmac_secret=hmac_secret,
        )
        if validate:
