...
class BaseApi(api_client.Api):
    ...
    def _download_report_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _adownload_report_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/data/v1/downloads/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _download_report_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DownloadReportByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adownload_report_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._download_report_by_id_mapped_args(
            id=id,
        )
        return await self._adownload_report_by_id_oapg(
    ...
    def download_report_by_id(
        ...
        return self._download_report_by_id_oapg(
            path_params=args.path,
        )

class DownloadReportById(BaseApi):
    ...
    async def adownload_report_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adownload_report_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def download_report_by_id(
        ...
        raw_response = self.raw.download_report_by_id(
            id=id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
