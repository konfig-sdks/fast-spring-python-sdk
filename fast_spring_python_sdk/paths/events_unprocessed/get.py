...
# Query params
BeginSchema = schemas.Int64Schema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'begin': typing.Union[BeginSchema, decimal.Decimal, int, ],
    }
)
...
request_query_begin = api_client.QueryParameter(
    name="begin",
...
class BaseApi(api_client.Api):
    ...
    def _get_unprocessed_events_mapped_args(
        self,
        begin: int,
        ...
        if begin is not None:
            _query_params["begin"] = begin
        args.query = _query_params
        return args

    async def _aget_unprocessed_events_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/events/unprocessed',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_unprocessed_events_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUnprocessedEventsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_unprocessed_events(
        self,
        begin: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_unprocessed_events_mapped_args(
            begin=begin,
        )
        return await self._aget_unprocessed_events_oapg(
    ...
    def get_unprocessed_events(
        ...
        return self._get_unprocessed_events_oapg(
            query_params=args.query,
        )

class GetUnprocessedEvents(BaseApi):
    ...
    async def aget_unprocessed_events(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_unprocessed_events(
            begin=begin,
            **kwargs,
        )
        if validate:
    ...
    def get_unprocessed_events(
        ...
        raw_response = self.raw.get_unprocessed_events(
            begin=begin,
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
