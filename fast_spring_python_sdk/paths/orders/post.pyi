...
from fast_spring_python_sdk.model.orders_update_tags_and_attributes_response import OrdersUpdateTagsAndAttributesResponse as OrdersUpdateTagsAndAttributesResponseSchema

from fast_spring_python_sdk.type.orders_update_tags_and_attributes_response import OrdersUpdateTagsAndAttributesResponse

from ...api_client import Dictionary
from fast_spring_python_sdk.pydantic.orders_update_tags_and_attributes_response import OrdersUpdateTagsAndAttributesResponse as OrdersUpdateTagsAndAttributesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrdersUpdateTagsAndAttributesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrdersUpdateTagsAndAttributesResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_tags_and_attributes_mapped_args(
        self,
    ...
    async def _aupdate_tags_and_attributes_oapg(
        self,
    ...
    def _update_tags_and_attributes_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateTagsAndAttributesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_tags_and_attributes(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._update_tags_and_attributes_mapped_args(
            body=body,
        )
        return await self._aupdate_tags_and_attributes_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_tags_and_attributes(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._update_tags_and_attributes_oapg(
            body=args.body,
        )

class UpdateTagsAndAttributes(BaseApi):
    ...
    async def aupdate_tags_and_attributes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrdersUpdateTagsAndAttributesResponsePydantic:
        raw_response = await self.raw.aupdate_tags_and_attributes(
            body=body,
            **kwargs,
        )
        if validate:
            return RootModel[OrdersUpdateTagsAndAttributesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(OrdersUpdateTagsAndAttributesResponsePydantic, raw_response.body)
    ...
    def update_tags_and_attributes(
        ...
        raw_response = self.raw.update_tags_and_attributes(
            body=body,
        )
        if validate:
            return RootModel[OrdersUpdateTagsAndAttributesResponsePydantic](raw_response.body).root
