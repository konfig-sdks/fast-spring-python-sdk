...
from fast_spring_python_sdk.model.estimate_subscription_request import EstimateSubscriptionRequest as EstimateSubscriptionRequestSchema
from fast_spring_python_sdk.model.subscription_addon import SubscriptionAddon as SubscriptionAddonSchema

from fast_spring_python_sdk.type.subscription_addon import SubscriptionAddon
from fast_spring_python_sdk.type.estimate_subscription_request import EstimateSubscriptionRequest

from ...api_client import Dictionary
from fast_spring_python_sdk.pydantic.estimate_subscription_request import EstimateSubscriptionRequest as EstimateSubscriptionRequestPydantic
from fast_spring_python_sdk.pydantic.subscription_addon import SubscriptionAddon as SubscriptionAddonPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = EstimateSubscriptionRequestSchema


request_body_estimate_subscription_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _preview_plan_change_mapped_args(
        self,
        subscription: str,
        product: typing.Optional[str] = None,
        quantity: typing.Optional[int] = None,
        pricing: typing.Optional[Price] = None,
        addons: typing.Optional[typing.List[SubscriptionAddon]] = None,
        ...
        if pricing is not None:
            _body["pricing"] = pricing
        if addons is not None:
            _body["addons"] = addons
        args.body = _body
        return args

    async def _apreview_plan_change_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/subscriptions/estimate',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_estimate_subscription_request.serialize(body, content_type)
...
class PreviewPlanChangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apreview_plan_change(
        self,
        subscription: str,
        product: typing.Optional[str] = None,
        quantity: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._preview_plan_change_mapped_args(
        ...
        return await self._apreview_plan_change_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def preview_plan_change(
        ...
        return self._preview_plan_change_oapg(
            body=args.body,
        )

class PreviewPlanChange(BaseApi):
    ...
    async def apreview_plan_change(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apreview_plan_change(
            subscription=subscription,
            product=product,
            quantity=quantity,
            pricing=pricing,
    ...
    def preview_plan_change(
        ...
        raw_response = self.raw.preview_plan_change(
            subscription=subscription,
            product=product,
            quantity=quantity,
            pricing=pricing,
