...
class BaseApi(api_client.Api):
    ...
    def _get_all_product_prices_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_all_product_prices_oapg(
        self,
    ...
    def _get_all_product_prices_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetAllProductPricesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_product_prices(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_all_product_prices_mapped_args(
        )
        return await self._aget_all_product_prices_oapg(
            **kwargs,
        )
    ...
    def get_all_product_prices(
        ...
        return self._get_all_product_prices_oapg(
        )

class GetAllProductPrices(BaseApi):
    ...
    async def aget_all_product_prices(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_product_prices(
            **kwargs,
        )
        if validate:
    ...
    def get_all_product_prices(
        ...
        raw_response = self.raw.get_all_product_prices(
        )
        if validate:
            return RootModel[typing.Union[bool, date, datetime, dict, float, int, list, str, None]](raw_response.body).root
        return raw_response.body
