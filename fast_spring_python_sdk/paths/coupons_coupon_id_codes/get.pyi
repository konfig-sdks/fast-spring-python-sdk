...
class BaseApi(api_client.Api):
    ...
    def _get_codes_assigned_to_coupon_mapped_args(
        self,
        coupon_id: str,
    ...
    async def _aget_codes_assigned_to_coupon_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/coupons/{coupon_id}/codes',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_codes_assigned_to_coupon_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCodesAssignedToCouponRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_codes_assigned_to_coupon(
        self,
        coupon_id: str,
        body: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
        **kwargs,
        ...
        args = self._get_codes_assigned_to_coupon_mapped_args(
            body=body,
            coupon_id=coupon_id,
        )
        return await self._aget_codes_assigned_to_coupon_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def get_codes_assigned_to_coupon(
        self,
        coupon_id: str,
        body: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
    ) -> typing.Union[
        ...
        return self._get_codes_assigned_to_coupon_oapg(
            body=args.body,
            path_params=args.path,
        )

class GetCodesAssignedToCoupon(BaseApi):
    ...
    async def aget_codes_assigned_to_coupon(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_codes_assigned_to_coupon(
            body=body,
            coupon_id=coupon_id,
            **kwargs,
        )
    ...
    def get_codes_assigned_to_coupon(
        ...
        raw_response = self.raw.get_codes_assigned_to_coupon(
            body=body,
            coupon_id=coupon_id,
        )
        if validate:
