...
class BaseApi(api_client.Api):
    ...
    def _delete_associated_codes_mapped_args(
        self,
        coupon_id: str,
    ...
    async def _adelete_associated_codes_oapg(
        self,
    ...
    def _delete_associated_codes_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteAssociatedCodesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_associated_codes(
        self,
        coupon_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_associated_codes_mapped_args(
            coupon_id=coupon_id,
        )
        return await self._adelete_associated_codes_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_associated_codes(
        self,
        coupon_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._delete_associated_codes_oapg(
            path_params=args.path,
        )

class DeleteAssociatedCodes(BaseApi):
    ...
    async def adelete_associated_codes(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_associated_codes(
            coupon_id=coupon_id,
            **kwargs,
        )
    ...
    def delete_associated_codes(
        ...
        raw_response = self.raw.delete_associated_codes(
            coupon_id=coupon_id,
        )
