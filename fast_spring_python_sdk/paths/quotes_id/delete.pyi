...
class BaseApi(api_client.Api):
    ...
    def _delete_quote_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_quote_by_id_oapg(
        self,
...
class DeleteQuoteByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_quote_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_quote_by_id_mapped_args(
            id=id,
        )
        return await self._adelete_quote_by_id_oapg(
    ...
    def delete_quote_by_id(
        ...
        return self._delete_quote_by_id_oapg(
            path_params=args.path,
        )

class DeleteQuoteById(BaseApi):
    ...
    async def adelete_quote_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_quote_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def delete_quote_by_id(
        ...
        raw_response = self.raw.delete_quote_by_id(
            id=id,
        )
        if validate:
            return QuoteResponsePydantic(**raw_response.body)
