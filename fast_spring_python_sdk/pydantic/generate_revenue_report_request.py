...
from fast_spring_python_sdk.pydantic.filter_revenue_report_request import FilterRevenueReportRequest
from fast_spring_python_sdk.pydantic.generate_revenue_report_request_group_by import GenerateRevenueReportRequestGroupBy
from fast_spring_python_sdk.pydantic.generate_revenue_report_request_notification_emails import GenerateRevenueReportRequestNotificationEmails
from fast_spring_python_sdk.pydantic.generate_revenue_report_request_report_columns import GenerateRevenueReportRequestReportColumns

class GenerateRevenueReportRequest(BaseModel):
    filter: typing.Optional[FilterRevenueReportRequest] = Field(None, alias='filter')

    report_columns: typing.Optional[GenerateRevenueReportRequestReportColumns] = Field(None, alias='reportColumns')

    group_by: typing.Optional[GenerateRevenueReportRequestGroupBy] = Field(None, alias='groupBy')
    ...
    notification_emails: typing.Optional[GenerateRevenueReportRequestNotificationEmails] = Field(None, alias='notificationEmails')
    class Config:
