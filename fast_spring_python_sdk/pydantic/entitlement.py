...
from fast_spring_python_sdk.pydantic.entitlement_roles import EntitlementRoles
from fast_spring_python_sdk.pydantic.entitlement_site_ids import EntitlementSiteIds
from fast_spring_python_sdk.pydantic.store_entitlement import StoreEntitlement
...
class Entitlement(BaseModel):
    ...
    site_ids: typing.Optional[EntitlementSiteIds] = Field(None, alias='siteIds')

    roles: typing.Optional[EntitlementRoles] = Field(None, alias='roles')

    store_entitlements: typing.Optional[typing.List[StoreEntitlement]] = Field(None, alias='storeEntitlements')
    class Config:
