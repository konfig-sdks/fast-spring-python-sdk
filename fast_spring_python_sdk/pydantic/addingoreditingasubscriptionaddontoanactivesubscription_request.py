...
from fast_spring_python_sdk.pydantic.subscription3 import Subscription3

class AddingoreditingasubscriptionaddontoanactivesubscriptionRequest(BaseModel):
    subscriptions: typing.List[Subscription3] = Field(alias='subscriptions')
    class Config:
