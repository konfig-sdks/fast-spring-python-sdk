...
from fast_spring_python_sdk.pydantic.store_entitlement_roles import StoreEntitlementRoles

class StoreEntitlement(BaseModel):
    site_id: typing.Optional[str] = Field(None, alias='siteId')

    roles: typing.Optional[StoreEntitlementRoles] = Field(None, alias='roles')
    class Config:
