...
from fast_spring_python_sdk.pydantic.item3 import Item3

class CreateasessionoverridingaproductsdefaultpricingRequest(BaseModel):
    account: str = Field(alias='account')

    items: typing.List[Item3] = Field(alias='items')
    class Config:
