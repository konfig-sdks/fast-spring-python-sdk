...
from fast_spring_python_sdk.pydantic.filter_revenue_report_request_country_iso import FilterRevenueReportRequestCountryIso
from fast_spring_python_sdk.pydantic.filter_revenue_report_request_product_names import FilterRevenueReportRequestProductNames
from fast_spring_python_sdk.pydantic.filter_revenue_report_request_product_paths import FilterRevenueReportRequestProductPaths

class FilterRevenueReportRequest(BaseModel):
    start_date: typing.Optional[date] = Field(None, alias='startDate')

    end_date: typing.Optional[date] = Field(None, alias='endDate')

    country_i_s_o: typing.Optional[FilterRevenueReportRequestCountryIso] = Field(None, alias='countryISO')

    product_names: typing.Optional[FilterRevenueReportRequestProductNames] = Field(None, alias='productNames')

    product_paths: typing.Optional[FilterRevenueReportRequestProductPaths] = Field(None, alias='productPaths')
