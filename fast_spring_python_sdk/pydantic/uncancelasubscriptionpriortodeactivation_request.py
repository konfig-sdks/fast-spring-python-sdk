...
from fast_spring_python_sdk.pydantic.subscription6 import Subscription6

class UncancelasubscriptionpriortodeactivationRequest(BaseModel):
    subscriptions: typing.List[Subscription6] = Field(alias='subscriptions')
    class Config:
