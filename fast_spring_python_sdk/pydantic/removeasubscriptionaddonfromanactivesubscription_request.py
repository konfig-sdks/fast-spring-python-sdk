...
from fast_spring_python_sdk.pydantic.subscription4 import Subscription4

class RemoveasubscriptionaddonfromanactivesubscriptionRequest(BaseModel):
    subscriptions: typing.List[Subscription4] = Field(alias='subscriptions')
    class Config:
