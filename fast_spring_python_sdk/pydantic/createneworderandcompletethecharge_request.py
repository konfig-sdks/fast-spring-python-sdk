...
from fast_spring_python_sdk.pydantic.item import Item
from fast_spring_python_sdk.pydantic.tags import Tags

class CreateneworderandcompletethechargeRequest(BaseModel):
    tags: Tags = Field(alias='tags')

    account: str = Field(alias='account')

    coupon: str = Field(alias='coupon')
