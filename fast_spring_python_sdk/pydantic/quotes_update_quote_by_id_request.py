...
from fast_spring_python_sdk.pydantic.update_quote_request import UpdateQuoteRequest

class QuotesUpdateQuoteByIdRequest(BaseModel):
    update_quote_request: typing.Optional[UpdateQuoteRequest] = Field(None, alias='updateQuoteRequest')
    class Config:
