...
from fast_spring_python_sdk.pydantic.subscription7 import Subscription7

class RebillmanagedsubscriptioninstanceRequest(BaseModel):
    subscriptions: typing.List[Subscription7] = Field(alias='subscriptions')
    class Config:
