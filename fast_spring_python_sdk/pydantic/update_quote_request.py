...
from fast_spring_python_sdk.pydantic.address_request import AddressRequest
from fast_spring_python_sdk.pydantic.contact_request import ContactRequest
from fast_spring_python_sdk.pydantic.item_request import ItemRequest
from fast_spring_python_sdk.pydantic.tag_request import TagRequest

class UpdateQuoteRequest(BaseModel):
    currency: str = Field(alias='currency')

    expiration_date_days: int = Field(alias='expirationDateDays')

    fulfillment_term: str = Field(alias='fulfillmentTerm')

    items: typing.List[ItemRequest] = Field(alias='items')

    name: str = Field(alias='name')

    recipient_address: AddressRequest = Field(alias='recipientAddress')

    recipient: ContactRequest = Field(alias='recipient')

    tags: typing.Optional[typing.List[TagRequest]] = Field(None, alias='tags')
