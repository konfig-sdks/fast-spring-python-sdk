...
from fast_spring_python_sdk.pydantic.subscription_addon import SubscriptionAddon

class EstimateSubscriptionRequest(BaseModel):
    ...
    pricing: typing.Optional[Price] = Field(None, alias='pricing')

    addons: typing.Optional[typing.List[SubscriptionAddon]] = Field(None, alias='addons')
    class Config:
