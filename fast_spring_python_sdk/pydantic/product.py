...
from fast_spring_python_sdk.pydantic.attributes2 import Attributes2
from fast_spring_python_sdk.pydantic.description import Description
from fast_spring_python_sdk.pydantic.display import Display
from fast_spring_python_sdk.pydantic.fulfillment import Fulfillment
from fast_spring_python_sdk.pydantic.pricing1 import Pricing1
...
class Product(BaseModel):
    ...
    fulfillment: Fulfillment = Field(alias='fulfillment')
    ...
    attributes: Attributes2 = Field(alias='attributes')

    pricing: Pricing1 = Field(alias='pricing')
    class Config:
