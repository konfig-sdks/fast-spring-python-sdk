...
from fast_spring_python_sdk.pydantic.subscription1 import Subscription1

class ChangethedateQuantityorcouponforanactivesubscriptionRequest(BaseModel):
    subscriptions: typing.List[Subscription1] = Field(alias='subscriptions')
    class Config:
