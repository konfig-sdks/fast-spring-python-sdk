...
from fast_spring_python_sdk.pydantic.quote_response import QuoteResponse

class CollectionModelQuoteResponse(BaseModel):
    links: typing.Optional[typing.List[Link]] = Field(None, alias='links')

    content: typing.Optional[typing.List[QuoteResponse]] = Field(None, alias='content')
    class Config:
