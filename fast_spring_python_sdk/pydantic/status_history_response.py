...
class StatusHistoryResponse(BaseModel):
    status_updated_to: typing.Optional[Literal["OPEN", "CANCELED", "AWAITING_PAYMENT", "COMPLETED", "EXPIRED"]] = Field(None, alias='statusUpdatedTo')

    status_updated_by_full_name: typing.Optional[str] = Field(None, alias='statusUpdatedByFullName')

    status_updated_by_email: typing.Optional[str] = Field(None, alias='statusUpdatedByEmail')

    status_updated_on: typing.Optional[datetime] = Field(None, alias='statusUpdatedOn')
    class Config:
