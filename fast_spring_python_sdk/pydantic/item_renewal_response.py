...
class ItemRenewalResponse(BaseModel):
    renew_into_product_id: typing.Optional[str] = Field(None, alias='renewIntoProductId')

    renew_into_path: typing.Optional[str] = Field(None, alias='renewIntoPath')

    renew_into_price: typing.Optional[typing.Union[int, float]] = Field(None, alias='renewIntoPrice')

    renew_into_period: typing.Optional[str] = Field(None, alias='renewIntoPeriod')

    renew_into_level: typing.Optional[int] = Field(None, alias='renewIntoLevel')

    renew_into_interval_count: typing.Optional[str] = Field(None, alias='renewIntoIntervalCount')

    renew_into_upcoming_product: typing.Optional[str] = Field(None, alias='renewIntoUpcomingProduct')
    class Config:
