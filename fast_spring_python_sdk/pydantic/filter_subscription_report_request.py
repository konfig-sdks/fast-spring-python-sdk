...
from fast_spring_python_sdk.pydantic.filter_subscription_report_request_country_iso import FilterSubscriptionReportRequestCountryIso
from fast_spring_python_sdk.pydantic.filter_subscription_report_request_product_names import FilterSubscriptionReportRequestProductNames
from fast_spring_python_sdk.pydantic.filter_subscription_report_request_product_paths import FilterSubscriptionReportRequestProductPaths

class FilterSubscriptionReportRequest(BaseModel):
    start_date: typing.Optional[date] = Field(None, alias='startDate')

    end_date: typing.Optional[date] = Field(None, alias='endDate')

    country_i_s_o: typing.Optional[FilterSubscriptionReportRequestCountryIso] = Field(None, alias='countryISO')

    product_names: typing.Optional[FilterSubscriptionReportRequestProductNames] = Field(None, alias='productNames')

    product_paths: typing.Optional[FilterSubscriptionReportRequestProductPaths] = Field(None, alias='productPaths')

    sync_date: typing.Optional[date] = Field(None, alias='syncDate')
    class Config:
