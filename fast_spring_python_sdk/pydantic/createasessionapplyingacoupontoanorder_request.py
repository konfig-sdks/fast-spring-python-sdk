...
from fast_spring_python_sdk.pydantic.item2 import Item2

class CreateasessionapplyingacoupontoanorderRequest(BaseModel):
    account: str = Field(alias='account')

    items: typing.List[Item2] = Field(alias='items')
