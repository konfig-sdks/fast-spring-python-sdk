...
from fast_spring_python_sdk.pydantic.entitlement import Entitlement
from fast_spring_python_sdk.pydantic.user_principal_roles import UserPrincipalRoles
from fast_spring_python_sdk.pydantic.user_principal_site_ids import UserPrincipalSiteIds
...
class UserPrincipal(BaseModel):
    ...
    site_ids: typing.Optional[UserPrincipalSiteIds] = Field(None, alias='siteIds')
    ...
    site_name: typing.Optional[str] = Field(None, alias='siteName')

    login_token: typing.Optional[str] = Field(None, alias='loginToken')

    roles: typing.Optional[UserPrincipalRoles] = Field(None, alias='roles')

    api_access: typing.Optional[bool] = Field(None, alias='apiAccess')
    ...
    client_credentials: typing.Optional[bool] = Field(None, alias='clientCredentials')

    auth_provider_type: typing.Optional[Literal["COGNITO", "COMMERCE", "SOCIAL_GOOGLE"]] = Field(None, alias='authProviderType')

    access_token: typing.Optional[str] = Field(None, alias='accessToken')

    token_expires: typing.Optional[int] = Field(None, alias='tokenExpires')
    class Config:
