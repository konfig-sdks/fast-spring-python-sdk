...
from fast_spring_python_sdk.pydantic.contact import Contact
from fast_spring_python_sdk.pydantic.lookup import Lookup

class UpdateexistingaccountRequest(BaseModel):
    ...
    lookup: Lookup = Field(alias='lookup')
    class Config:
