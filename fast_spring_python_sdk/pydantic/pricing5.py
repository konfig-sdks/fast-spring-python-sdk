...
from fast_spring_python_sdk.pydantic.discount3 import Discount3
from fast_spring_python_sdk.pydantic.price4 import Price4

class Pricing5(BaseModel):
    price: Price4 = Field(alias='price')

    discount: Discount3 = Field(alias='discount')
    class Config:
