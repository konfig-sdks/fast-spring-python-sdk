...
from fast_spring_python_sdk.pydantic.addcouponcodestoacoupon_request_codes import AddcouponcodestoacouponRequestCodes

class AddcouponcodestoacouponRequest(BaseModel):
    codes: AddcouponcodestoacouponRequestCodes = Field(alias='codes')
    class Config:
