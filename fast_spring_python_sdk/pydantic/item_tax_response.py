...
class ItemTaxResponse(BaseModel):
    tax_value: typing.Optional[typing.Union[int, float]] = Field(None, alias='taxValue')

    total_taxable: typing.Optional[typing.Union[int, float]] = Field(None, alias='totalTaxable')
    class Config:
