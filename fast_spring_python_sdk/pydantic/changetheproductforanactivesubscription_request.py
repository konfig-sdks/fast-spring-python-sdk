...
from fast_spring_python_sdk.pydantic.subscription import Subscription

class ChangetheproductforanactivesubscriptionRequest(BaseModel):
    subscriptions: typing.List[Subscription] = Field(alias='subscriptions')
    class Config:
