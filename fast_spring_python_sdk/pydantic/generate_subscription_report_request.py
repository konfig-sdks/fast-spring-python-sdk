...
from fast_spring_python_sdk.pydantic.filter_subscription_report_request import FilterSubscriptionReportRequest
from fast_spring_python_sdk.pydantic.generate_subscription_report_request_group_by import GenerateSubscriptionReportRequestGroupBy
from fast_spring_python_sdk.pydantic.generate_subscription_report_request_notification_emails import GenerateSubscriptionReportRequestNotificationEmails
from fast_spring_python_sdk.pydantic.generate_subscription_report_request_report_columns import GenerateSubscriptionReportRequestReportColumns

class GenerateSubscriptionReportRequest(BaseModel):
    filter: typing.Optional[FilterSubscriptionReportRequest] = Field(None, alias='filter')

    report_columns: typing.Optional[GenerateSubscriptionReportRequestReportColumns] = Field(None, alias='reportColumns')

    group_by: typing.Optional[GenerateSubscriptionReportRequestGroupBy] = Field(None, alias='groupBy')
    ...
    notification_emails: typing.Optional[GenerateSubscriptionReportRequestNotificationEmails] = Field(None, alias='notificationEmails')
    class Config:
