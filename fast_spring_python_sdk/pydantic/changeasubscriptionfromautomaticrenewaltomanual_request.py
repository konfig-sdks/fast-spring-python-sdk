...
from fast_spring_python_sdk.pydantic.subscription5 import Subscription5

class ChangeasubscriptionfromautomaticrenewaltomanualRequest(BaseModel):
    subscriptions: typing.List[Subscription5] = Field(alias='subscriptions')
    class Config:
