...
from fast_spring_python_sdk.pydantic.sort import Sort

class Pageable(BaseModel):
    offset: typing.Optional[int] = Field(None, alias='offset')

    paged: typing.Optional[bool] = Field(None, alias='paged')

    unpaged: typing.Optional[bool] = Field(None, alias='unpaged')

    sort: typing.Optional[Sort] = Field(None, alias='sort')
