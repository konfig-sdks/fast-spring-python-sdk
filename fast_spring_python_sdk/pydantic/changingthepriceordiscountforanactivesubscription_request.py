...
from fast_spring_python_sdk.pydantic.subscription2 import Subscription2

class ChangingthepriceordiscountforanactivesubscriptionRequest(BaseModel):
    subscriptions: typing.List[Subscription2] = Field(alias='subscriptions')
    class Config:
