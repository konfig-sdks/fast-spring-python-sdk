...
from fast_spring_python_sdk.pydantic.webhooks_update_webhook_key_secret400_response_error import WebhooksUpdateWebhookKeySecret400ResponseError

class WebhooksUpdateWebhookKeySecret400Response(BaseModel):
    action: typing.Optional[str] = Field(None, alias='action')

    result: typing.Optional[str] = Field(None, alias='result')

    error: typing.Optional[WebhooksUpdateWebhookKeySecret400ResponseError] = Field(None, alias='error')
    class Config:
