...
setup(
    name=NAME,
    version=VERSION,
    description="FastSpring API",
    author="Konfig",
    author_email="engineering@konfigthis.com",
    url="https://github.com/konfig-sdks/fast-spring-python-sdk/tree/main/python",
    keywords=["Konfig", "FastSpring API"],
    python_requires=">=3.7",
